...
<body>
                      ...
                      <div class="">
                        ...
                        if (isset($_GET['filterType']) && $_GET['filterType'] == "quarter") {
                          if (isset($_GET['quarter']) && $_GET['quarter'] == "first") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT COUNT(DISTINCT(r.name)) AS `total` FROM `research_topic` AS rt INNER JOIN `research_representatives` AS rr ON rt.id = rr.research_topic_id INNER JOIN `representative` AS r ON rr.id = r.research_representatives_id WHERE rt.added_by = $id AND MONTH(rt.end_date) BETWEEN 1 and 3 AND YEAR(rt.end_date) = '$yearFilter'";
                            } else {
                              $sql = "SELECT COUNT(DISTINCT(r.name)) AS `total` FROM `research_topic` AS rt INNER JOIN `research_representatives` AS rr ON rt.id = rr.research_topic_id INNER JOIN `representative` AS r ON rr.id = r.research_representatives_id WHERE rt.added_by = $id AND MONTH(rt.end_date) BETWEEN 1 and 3";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "second") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT COUNT(DISTINCT(r.name)) AS `total` FROM `research_topic` AS rt INNER JOIN `research_representatives` AS rr ON rt.id = rr.research_topic_id INNER JOIN `representative` AS r ON rr.id = r.research_representatives_id WHERE rt.added_by = $id AND MONTH(rt.end_date) BETWEEN 4 and 6 AND YEAR(rt.end_date) = '$yearFilter'";
                            } else {
                              $sql = "SELECT COUNT(DISTINCT(r.name)) AS `total` FROM `research_topic` AS rt INNER JOIN `research_representatives` AS rr ON rt.id = rr.research_topic_id INNER JOIN `representative` AS r ON rr.id = r.research_representatives_id WHERE rt.added_by = $id AND MONTH(rt.end_date) BETWEEN 4 and 6";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "third") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT COUNT(DISTINCT(r.name)) AS `total` FROM `research_topic` AS rt INNER JOIN `research_representatives` AS rr ON rt.id = rr.research_topic_id INNER JOIN `representative` AS r ON rr.id = r.research_representatives_id WHERE rt.added_by = $id AND MONTH(rt.end_date) BETWEEN 7 and 9 AND YEAR(rt.end_date) = '$yearFilter'";
                            } else {
                              $sql = "SELECT COUNT(DISTINCT(r.name)) AS `total` FROM `research_topic` AS rt INNER JOIN `research_representatives` AS rr ON rt.id = rr.research_topic_id INNER JOIN `representative` AS r ON rr.id = r.research_representatives_id WHERE rt.added_by = $id AND MONTH(rt.end_date) BETWEEN 7 and 9";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "fourth") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT COUNT(DISTINCT(r.name)) AS `total` FROM `research_topic` AS rt INNER JOIN `research_representatives` AS rr ON rt.id = rr.research_topic_id INNER JOIN `representative` AS r ON rr.id = r.research_representatives_id WHERE rt.added_by = $id AND MONTH(rt.end_date) BETWEEN 10 and 12 AND YEAR(rt.end_date) = '$yearFilter'";
                            } else {
                              $sql = "SELECT COUNT(DISTINCT(r.name)) AS `total` FROM `research_topic` AS rt INNER JOIN `research_representatives` AS rr ON rt.id = rr.research_topic_id INNER JOIN `representative` AS r ON rr.id = r.research_representatives_id WHERE rt.added_by = $id AND MONTH(rt.end_date) BETWEEN 10 and 12";
                            }
                          } else {
                          ...
                          if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                            $yearFilter = $_GET['annual'];
                            $sql = "SELECT COUNT(DISTINCT(r.name)) AS `total` FROM `research_topic` AS rt INNER JOIN `research_representatives` AS rr ON rt.id = rr.research_topic_id INNER JOIN `representative` AS r ON rr.id = r.research_representatives_id WHERE rt.added_by = $id AND YEAR(rt.end_date) = '$yearFilter'";
                          } else {
                            $sql = "SELECT COUNT(DISTINCT(r.name)) AS `total` FROM `research_topic` AS rt INNER JOIN `research_representatives` AS rr ON rt.id = rr.research_topic_id INNER JOIN `representative` AS r ON rr.id = r.research_representatives_id WHERE rt.added_by = $id";
                          }
                        } else {
                      ...
                      <div class="">
                        ...
                        if (isset($_GET['filterType']) && $_GET['filterType'] == "quarter") {
                          if (isset($_GET['quarter']) && $_GET['quarter'] == "first") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND MONTH(to_conference) BETWEEN 1 and 3 AND YEAR(to_conference) = '$yearFilter'";

                              $sql2 = "SELECT COUNT(*) AS `total` FROM `seminar_training` WHERE added_by = $id AND MONTH(to_seminar) BETWEEN 1 and 3 AND YEAR(to_seminar) = '$yearFilter'";
                            } else {
                              $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND MONTH(to_conference) BETWEEN 1 and 3";
                              
                              $sql2 = "SELECT COUNT(*) AS `total` FROM `seminar_training` WHERE added_by = $id AND MONTH(to_seminar) BETWEEN 1 and 3";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "second") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND MONTH(to_conference) BETWEEN 4 and 6 AND YEAR(to_conference) = '$yearFilter'";

                              $sql2 = "SELECT COUNT(*) AS `total` FROM `seminar_training` WHERE added_by = $id AND MONTH(to_seminar) BETWEEN 4 and 6 AND YEAR(to_seminar) = '$yearFilter'";
                            } else {
                              $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND MONTH(to_conference) BETWEEN 4 and 6";

                              $sql2 = "SELECT COUNT(*) AS `total` FROM `seminar_training` WHERE added_by = $id AND MONTH(to_seminar) BETWEEN 4 and 6";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "third") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND MONTH(to_conference) BETWEEN 7 and 9 AND YEAR(to_conference) = '$yearFilter'";

                              $sql2 = "SELECT COUNT(*) AS `total` FROM `seminar_training` WHERE added_by = $id AND MONTH(to_seminar) BETWEEN 7 and 9 AND YEAR(to_seminar) = '$yearFilter'";
                            } else {
                              $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND MONTH(to_conference) BETWEEN 7 and 9";

                              $sql2 = "SELECT COUNT(*) AS `total` FROM `seminar_training` WHERE added_by = $id AND MONTH(to_seminar) BETWEEN 7 and 9";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "fourth") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND MONTH(to_conference) BETWEEN 10 and 12 AND YEAR(to_conference) = '$yearFilter'";

                              $sql2 = "SELECT COUNT(*) AS `total` FROM `seminar_training` WHERE added_by = $id AND MONTH(to_seminar) BETWEEN 10 and 12 AND YEAR(to_seminar) = '$yearFilter'";
                            } else {
                              $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND MONTH(to_conference) BETWEEN 10 and 12";

                              $sql2 = "SELECT COUNT(*) AS `total` FROM `seminar_training` WHERE added_by = $id AND MONTH(to_seminar) BETWEEN 10 and 12";
                            }
                          } else {
                            $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id";

                            $sql2 = "SELECT COUNT(*) AS `total` FROM `seminar_training` WHERE added_by = $id";
                          }
                        } elseif (isset($_GET['filterType']) && $_GET['filterType'] == "annual") {
                          if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                            $yearFilter = $_GET['annual'];
                            $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND YEAR(to_conference) = '$yearFilter'";

                            $sql2 = "SELECT COUNT(*) AS `total` FROM `seminar_training` WHERE added_by = $id AND YEAR(to_seminar) = '$yearFilter'";
                          } else {
                            $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id";
                      ...
                      <div class="">
                        ...
                        if (isset($_GET['filterType']) && $_GET['filterType'] == "quarter") {
                          if (isset($_GET['quarter']) && $_GET['quarter'] == "first") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT COUNT(*) AS `total` FROM `scw_` WHERE added_by = $id AND MONTH(year_published) BETWEEN 1 and 3 AND YEAR(year_published) = '$yearFilter'";
                            } else {
                              $sql = "SELECT COUNT(*) AS `total` FROM `scw_` WHERE added_by = $id AND MONTH(year_published) BETWEEN 1 and 3";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "second") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT COUNT(*) AS `total` FROM `scw_` WHERE added_by = $id AND MONTH(year_published) BETWEEN 4 and 6 AND YEAR(year_published) = '$yearFilter'";
                            } else {
                              $sql = "SELECT COUNT(*) AS `total` FROM `scw_` WHERE added_by = $id AND MONTH(year_published) BETWEEN 4 and 6";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "third") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT COUNT(*) AS `total` FROM `scw_` WHERE added_by = $id AND MONTH(year_published) BETWEEN 7 and 9 AND YEAR(year_published) = '$yearFilter'";
                            } else {
                              $sql = "SELECT COUNT(*) AS `total` FROM `scw_` WHERE added_by = $id AND MONTH(year_published) BETWEEN 7 and 9";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "fourth") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT COUNT(*) AS `total` FROM `scw_` WHERE added_by = $id AND MONTH(year_published) BETWEEN 10 and 12 AND YEAR(year_published) = '$yearFilter'";
                            } else {
                              $sql = "SELECT COUNT(*) AS `total` FROM `scw_` WHERE added_by = $id AND MONTH(year_published) BETWEEN 10 and 12";
                            }
                          } else {
                          ...
                          if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                            $yearFilter = $_GET['annual'];
                            $sql = "SELECT COUNT(*) AS `total` FROM `scw_` WHERE added_by = $id AND YEAR(year_published) = '$yearFilter'";
                          } else {
                            $sql = "SELECT COUNT(*) AS `total` FROM `scw_` WHERE added_by = $id";
                          }
                        } else {
                      ...
                      <div class="">
                        ...
                        if (isset($_GET['filterType']) && $_GET['filterType'] == "quarter") {
                          if (isset($_GET['quarter']) && $_GET['quarter'] == "first") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND MONTH(`rt`.`end_date`) BETWEEN 1 and 3 AND YEAR(`rt`.`end_date`) = '$yearFilter' AND NOT `status` LIKE 'For Evaluation'";
                            } else {
                              $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND MONTH(`rt`.`end_date`) BETWEEN 1 and 3 AND NOT `status` LIKE 'For Evaluation'";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "second") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND MONTH(`rt`.`end_date`) BETWEEN 4 and 6 AND YEAR(`rt`.`end_date`) = '$yearFilter' AND NOT `status` LIKE 'For Evaluation'";
                            } else {
                              $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND MONTH(`rt`.`end_date`) BETWEEN 4 and 6 AND NOT `status` LIKE 'For Evaluation'";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "third") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND MONTH(`rt`.`end_date`) BETWEEN 7 and 9 AND YEAR(`rt`.`end_date`) = '$yearFilter' AND NOT `status` LIKE 'For Evaluation'";
                            } else {
                              $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND MONTH(`rt`.`end_date`) BETWEEN 7 and 9 AND NOT `status` LIKE 'For Evaluation'";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "fourth") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND MONTH(`rt`.`end_date`) BETWEEN 10 and 12 AND YEAR(`rt`.`end_date`) = '$yearFilter' AND NOT `status` LIKE 'For Evaluation'";
                            } else {
                              $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND MONTH(`rt`.`end_date`) BETWEEN 10 and 12 AND NOT `status` LIKE 'For Evaluation'";
                            }
                          } else {
                          ...
                          if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                            $yearFilter = $_GET['annual'];
                            $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND YEAR(`rt`.`end_date`) = '$yearFilter' AND NOT `status` LIKE 'For Evaluation'";
                          } else {
                            $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND NOT `status` LIKE 'For Evaluation'";
                          }
                        } else {
                      ...
                      <div class="">
                        ...
                        if (isset($_GET['filterType']) && $_GET['filterType'] == "quarter") {
                          if (isset($_GET['quarter']) && $_GET['quarter'] == "first") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND MONTH(`rt`.`end_date`) BETWEEN 1 and 3 AND YEAR(`rt`.`end_date`) = '$yearFilter' AND `partnership` LIKE 'Institutionaly Funded' AND NOT `status` LIKE 'For Evaluation'";
                            } else {
                              $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND MONTH(`rt`.`end_date`) BETWEEN 1 and 3 AND `partnership` LIKE 'Institutionaly Funded' AND NOT `status` LIKE 'For Evaluation'";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "second") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND MONTH(`rt`.`end_date`) BETWEEN 4 and 6 AND YEAR(`rt`.`end_date`) = '$yearFilter' AND `partnership` LIKE 'Institutionaly Funded' AND NOT `status` LIKE 'For Evaluation'";
                            } else {
                              $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND MONTH(`rt`.`end_date`) BETWEEN 4 and 6 AND `partnership` LIKE 'Institutionaly Funded' AND NOT `status` LIKE 'For Evaluation'";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "third") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND MONTH(`rt`.`end_date`) BETWEEN 7 and 9 AND YEAR(`rt`.`end_date`) = '$yearFilter' AND `partnership` LIKE 'Institutionaly Funded' AND NOT `status` LIKE 'For Evaluation'";
                            } else {
                              $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND MONTH(`rt`.`end_date`) BETWEEN 7 and 9 AND `partnership` LIKE 'Institutionaly Funded' AND NOT `status` LIKE 'For Evaluation'";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "fourth") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND MONTH(`rt`.`end_date`) BETWEEN 10 and 12 AND YEAR(`rt`.`end_date`) = '$yearFilter' AND `partnership` LIKE 'Institutionaly Funded' AND NOT `status` LIKE 'For Evaluation'";
                            } else {
                              $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND MONTH(`rt`.`end_date`) BETWEEN 10 and 12 AND `partnership` LIKE 'Institutionaly Funded' AND NOT `status` LIKE 'For Evaluation'";
                            }
                          } else {
                            $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND `partnership` LIKE 'Institutionaly Funded' AND NOT `status` LIKE 'For Evaluation'";
                          }
                        } elseif (isset($_GET['filterType']) && $_GET['filterType'] == "annual") {
                          if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                            $yearFilter = $_GET['annual'];
                            $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND YEAR(`rt`.`end_date`) = '$yearFilter' AND `partnership` LIKE 'Institutionaly Funded' AND NOT `status` LIKE 'For Evaluation'";
                          } else {
                            $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND `partnership` LIKE 'Institutionaly Funded' AND NOT `status` LIKE 'For Evaluation'";
                          }
                        } else {
                      ...
                      <div class="">
                        ...
                        if (isset($_GET['filterType']) && $_GET['filterType'] == "quarter") {
                          if (isset($_GET['quarter']) && $_GET['quarter'] == "first") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND MONTH(`rt`.`end_date`) BETWEEN 1 and 3 AND YEAR(`rt`.`end_date`) = '$yearFilter' AND `partnership` LIKE 'Externaly Funded' AND NOT `status` LIKE 'For Evaluation'";
                            } else {
                              $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND MONTH(`rt`.`end_date`) BETWEEN 1 and 3 AND `partnership` LIKE 'Externaly Funded' AND NOT `status` LIKE 'For Evaluation'";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "second") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND MONTH(`rt`.`end_date`) BETWEEN 4 and 6 AND YEAR(`rt`.`end_date`) = '$yearFilter' AND `partnership` LIKE 'Externaly Funded' AND NOT `status` LIKE 'For Evaluation'";
                            } else {
                              $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND MONTH(`rt`.`end_date`) BETWEEN 4 and 6 AND `partnership` LIKE 'Externaly Funded' AND NOT `status` LIKE 'For Evaluation'";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "third") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND MONTH(`rt`.`end_date`) BETWEEN 7 and 9 AND YEAR(`rt`.`end_date`) = '$yearFilter' AND `partnership` LIKE 'Externaly Funded' AND NOT `status` LIKE 'For Evaluation'";
                            } else {
                              $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND MONTH(`rt`.`end_date`) BETWEEN 7 and 9 AND `partnership` LIKE 'Externaly Funded' AND NOT `status` LIKE 'For Evaluation'";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "fourth") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND MONTH(`rt`.`end_date`) BETWEEN 10 and 12 AND YEAR(`rt`.`end_date`) = '$yearFilter' AND `partnership` LIKE 'Externaly Funded' AND NOT `status` LIKE 'For Evaluation'";
                            } else {
                              $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND MONTH(`rt`.`end_date`) BETWEEN 10 and 12 AND `partnership` LIKE 'Externaly Funded' AND NOT `status` LIKE 'For Evaluation'";
                            }
                          } else {
                            $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND `partnership` LIKE 'Externaly Funded' AND NOT `status` LIKE 'For Evaluation'";
                          }
                        } elseif (isset($_GET['filterType']) && $_GET['filterType'] == "annual") {
                          if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                            $yearFilter = $_GET['annual'];
                            $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND YEAR(`rt`.`end_date`) = '$yearFilter' AND `partnership` LIKE 'Externaly Funded' AND NOT `status` LIKE 'For Evaluation'";
                          } else {
                            $sql = "SELECT SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `added_by` = $id AND `partnership` LIKE 'Externaly Funded' AND NOT `status` LIKE 'For Evaluation'";
                          }
                        } else {
                      ...
                      <div class="">
                        ...
                        if (isset($_GET['filterType']) && $_GET['filterType'] == "quarter") {
                          if (isset($_GET['quarter']) && $_GET['quarter'] == "first") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT COUNT(*) AS `total` FROM `inventions` WHERE added_by = $id AND MONTH(date_inventions) BETWEEN 1 and 3 AND YEAR(date_inventions) = '$yearFilter'";
                            } else {
                              $sql = "SELECT COUNT(*) AS `total` FROM `inventions` WHERE added_by = $id AND MONTH(date_inventions) BETWEEN 1 and 3";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "second") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT COUNT(*) AS `total` FROM `inventions` WHERE added_by = $id AND MONTH(date_inventions) BETWEEN 4 and 6 AND YEAR(date_inventions) = '$yearFilter'";
                            } else {
                              $sql = "SELECT COUNT(*) AS `total` FROM `inventions` WHERE added_by = $id AND MONTH(date_inventions) BETWEEN 4 and 6";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "third") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT COUNT(*) AS `total` FROM `inventions` WHERE added_by = $id AND MONTH(date_inventions) BETWEEN 7 and 9 AND YEAR(date_inventions) = '$yearFilter'";
                            } else {
                              $sql = "SELECT COUNT(*) AS `total` FROM `inventions` WHERE added_by = $id AND MONTH(date_inventions) BETWEEN 7 and 9";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "fourth") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT COUNT(*) AS `total` FROM `inventions` WHERE added_by = $id AND MONTH(date_inventions) BETWEEN 10 and 12 AND YEAR(date_inventions) = '$yearFilter'";
                            } else {
                              $sql = "SELECT COUNT(*) AS `total` FROM `inventions` WHERE added_by = $id AND MONTH(date_inventions) BETWEEN 10 and 12";
                            }
                          } else {
                          ...
                          if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                            $yearFilter = $_GET['annual'];
                            $sql = "SELECT COUNT(*) AS `total` FROM `inventions` WHERE added_by = $id AND YEAR(date_inventions) = '$yearFilter'";
                          } else {
                            $sql = "SELECT COUNT(*) AS `total` FROM `inventions` WHERE added_by = $id";
                          }
                        } else {
                      ...
                      <div class="">
                        ...
                        if (isset($_GET['filterType']) && $_GET['filterType'] == "quarter") {
                          if (isset($_GET['quarter']) && $_GET['quarter'] == "first") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND MONTH(to_conference) BETWEEN 1 and 3 AND YEAR(to_conference) = '$yearFilter' AND `participation` = 'Paper Presenter'";
                            } else {
                              $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND MONTH(to_conference) BETWEEN 1 and 3 AND `participation` = 'Paper Presenter'";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "second") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND MONTH(to_conference) BETWEEN 4 and 6 AND YEAR(to_conference) = '$yearFilter' AND `participation` = 'Paper Presenter'";
                            } else {
                              $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND MONTH(to_conference) BETWEEN 4 and 6 AND `participation` = 'Paper Presenter'";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "third") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND MONTH(to_conference) BETWEEN 7 and 9 AND YEAR(to_conference) = '$yearFilter' AND `participation` = 'Paper Presenter'";
                            } else {
                              $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND MONTH(to_conference) BETWEEN 7 and 9 AND `participation` = 'Paper Presenter'";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "fourth") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND MONTH(to_conference) BETWEEN 10 and 12 AND YEAR(to_conference) = '$yearFilter' AND `participation` = 'Paper Presenter'";
                            } else {
                              $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND MONTH(to_conference) BETWEEN 10 and 12 AND `participation` = 'Paper Presenter'";
                            }
                          } else {
                          ...
                          if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                            $yearFilter = $_GET['annual'];
                            $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND YEAR(to_conference) = '$yearFilter' AND `participation` = 'Paper Presenter'";
                          } else {
                            $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND `participation` = 'Paper Presenter'";
                          }
                        } else {
                      ...
                      <?php
                        if (isset($_GET['filterType']) && $_GET['filterType'] == "quarter") {
                          if (isset($_GET['quarter']) && $_GET['quarter'] == "first") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND MONTH(to_conference) BETWEEN 1 and 3 AND YEAR(to_conference) = '$yearFilter' AND `participation` = 'Poster Presenter'";
                            } else {
                              $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND MONTH(to_conference) BETWEEN 1 and 3 AND `participation` = 'Poster Presenter'";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "second") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND MONTH(to_conference) BETWEEN 4 and 6 AND YEAR(to_conference) = '$yearFilter' AND `participation` = 'Poster Presenter'";
                            } else {
                              $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND MONTH(to_conference) BETWEEN 4 and 6 AND `participation` = 'Poster Presenter'";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "third") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND MONTH(to_conference) BETWEEN 7 and 9 AND YEAR(to_conference) = '$yearFilter' AND `participation` = 'Poster Presenter'";
                            } else {
                              $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND MONTH(to_conference) BETWEEN 7 and 9 AND `participation` = 'Poster Presenter'";
                            }
                          } elseif (isset($_GET['quarter']) && $_GET['quarter'] == "fourth") {
                            $yearFilter = $_GET['annual'];
                            if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                              $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND MONTH(to_conference) BETWEEN 10 and 12 AND YEAR(to_conference) = '$yearFilter' AND `participation` = 'Poster Presenter'";
                            } else {
                              $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND MONTH(to_conference) BETWEEN 10 and 12 AND `participation` = 'Poster Presenter'";
                            }
                          } else {
                          ...
                          if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                            $yearFilter = $_GET['annual'];
                            $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND YEAR(to_conference) = '$yearFilter' AND `participation` = 'Poster Presenter'";
                          } else {
                            $sql = "SELECT COUNT(*) AS `total` FROM `conferences` WHERE added_by = $id AND `participation` = 'Poster Presenter'";
                          }
                        } else {
        ...
        datasets: [{
          ...
          data: <?php
                if (isset($_GET['filterType']) && $_GET['filterType'] == "quarter") {
                  ...
                  $yearFilter = $_GET['annual'];
                  if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                    $sql = "SELECT QUARTER(end_date) AS quarter, COUNT(*) AS total FROM research_topic WHERE `added_by` = $id AND YEAR(end_date) = '$yearFilter' GROUP BY QUARTER(end_date)";
                  } else {
                    $sql = "SELECT QUARTER(end_date) AS quarter, COUNT(*) AS total FROM research_topic WHERE `added_by` = $id GROUP BY QUARTER(end_date)";
                  }
                  $result = $conn->query($sql);
                  ...
                  $sql = "SELECT YEAR(end_date) AS year, COUNT(*) AS total FROM research_topic WHERE `added_by` = $id GROUP BY YEAR(end_date)";
                  $result = $conn->query($sql);
                  while($row = $result->fetch_assoc()) {
        ...
        datasets: [{
          ...
          data: [
            ...
            if (isset($_GET['filterType']) && $_GET['filterType'] == "quarter") {
              ...
              $yearFilter = $_GET['annual'];
              if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                $sql = "SELECT QUARTER(rt.end_date) AS quarter, count(DISTINCT r.name) AS total FROM `research_topic` AS rt INNER JOIN research_representatives AS rr ON rt.id = rr.research_topic_id INNER JOIN representative AS r ON rr.id = r.research_representatives_id WHERE `added_by` = $id AND YEAR(rt.end_date) = '$yearFilter' GROUP BY QUARTER(rt.end_date)";
              } else {
                $sql = "SELECT QUARTER(rt.end_date) AS quarter, count(DISTINCT r.name) AS total FROM `research_topic` AS rt INNER JOIN research_representatives AS rr ON rt.id = rr.research_topic_id INNER JOIN representative AS r ON rr.id = r.research_representatives_id WHERE `added_by` = $id GROUP BY QUARTER(rt.end_date)";
              }
              $result = $conn->query($sql);
              while($row = $result->fetch_assoc()) {
                if(in_array($row['quarter'], $labels)) {
              ...
              $labels = $yearArray;
              $data = array("0", "0", "0", "0", "0");
              $sql = "SELECT YEAR(rt.end_date) AS year, count(DISTINCT r.name) AS total FROM `research_topic` AS rt INNER JOIN research_representatives AS rr ON rt.id = rr.research_topic_id INNER JOIN representative AS r ON rr.id = r.research_representatives_id WHERE `added_by` = $id GROUP BY YEAR(rt.end_date)";
              $result = $conn->query($sql);
              while($row = $result->fetch_assoc()) {
                if(in_array($row['year'], $labels)) {
                  $index = array_search($row['year'], $labels);
            ...
            datasets: [{
              ...
              data: [
                ...
                if (isset($_GET['filterType']) && $_GET['filterType'] == "quarter") {
                  ...
                  $yearFilter = $_GET['annual'];
                  if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                    $sql = "SELECT QUARTER(to_conference) AS quarter, COUNT(*) AS total FROM `conferences` WHERE added_by = $id AND YEAR(to_conference) = '$yearFilter' GROUP BY QUARTER(to_conference)";

                    $sql2 = "SELECT QUARTER(to_seminar) AS quarter, COUNT(*) AS total FROM `seminar_training` WHERE added_by = $id AND YEAR(to_seminar) = '$yearFilter' GROUP BY QUARTER(to_seminar)";
                  } else {
                    $sql = "SELECT QUARTER(to_conference) AS quarter, COUNT(*) AS total FROM `conferences` WHERE added_by = $id GROUP BY QUARTER(to_conference)";
                    
                    $sql2 = "SELECT QUARTER(to_seminar) AS quarter, COUNT(*) AS total FROM `seminar_training` WHERE added_by = $id GROUP BY QUARTER(to_seminar)";
                  }
                  $result = $conn->query($sql);
                  while($row = $result->fetch_assoc()) {
                    if(in_array($row['quarter'], $labels)) {
                  ...
                  $labels = $yearArray;
                  $data = array(0, 0, 0, 0, 0);
                  $sql = "SELECT YEAR(to_conference) AS year, COUNT(*) AS total FROM `conferences` WHERE added_by = $id GROUP BY YEAR(to_conference)";
                  $sql2 = "SELECT YEAR(to_seminar) AS year, COUNT(*) AS total FROM `seminar_training` WHERE added_by = $id GROUP BY YEAR(to_seminar)";
                  $result = $conn->query($sql);
                  while($row = $result->fetch_assoc()) {
                    if(in_array($row['year'], $labels)) {
                      $index = array_search($row['year'], $labels);
            ...
            datasets: [{
              ...
              data: [
                ...
                if (isset($_GET['filterType']) && $_GET['filterType'] == "quarter") {
                  ...
                  $yearFilter = $_GET['annual'];
                  if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                    $sql = "SELECT QUARTER(year_published) AS quarter, COUNT(*) AS total FROM `scw_` WHERE added_by = $id AND YEAR(year_published) = '$yearFilter' GROUP BY QUARTER(year_published)";
                  } else {
                    $sql = "SELECT QUARTER(year_published) AS quarter, COUNT(*) AS total FROM `scw_` WHERE added_by = $id GROUP BY QUARTER(year_published)";
                  }
                  $result = $conn->query($sql);
                  while($row = $result->fetch_assoc()) {
                    if(in_array($row['quarter'], $labels)) {
                  ...
                  $labels = $yearArray;
                  $data = array("0", "0", "0", "0", "0");
                  $sql = "SELECT YEAR(year_published) AS year, COUNT(*) AS total FROM `scw_` WHERE added_by = $id GROUP BY YEAR(year_published)";
                  $result = $conn->query($sql);
                  while($row = $result->fetch_assoc()) {
                    if(in_array($row['year'], $labels)) {
                      $index = array_search($row['year'], $labels);
            ...
            datasets: [{
              ...
              data: [
                ...
                if (isset($_GET['filterType']) && $_GET['filterType'] == "quarter") {
                  ...
                  $yearFilter = $_GET['annual'];
                  if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                    $sql = "SELECT QUARTER(end_date) AS quarter, COUNT(*) AS total FROM research_topic WHERE status = 'Completed' AND added_by = $id AND YEAR(end_date) = '$yearFilter' GROUP BY QUARTER(end_date)";
                  } else {
                    $sql = "SELECT QUARTER(end_date) AS quarter, COUNT(*) AS total FROM research_topic WHERE status = 'Completed' AND added_by = $id GROUP BY QUARTER(end_date)";
                  }
                  $result = $conn->query($sql);
                  while($row = $result->fetch_assoc()) {
                    if(in_array($row['quarter'], $labels)) {
                  ...
                  $labels = $yearArray;
                  $data = array("0", "0", "0", "0", "0");
                  $sql = "SELECT YEAR(end_date) AS year, COUNT(*) AS total FROM research_topic WHERE status = 'Completed' AND added_by = $id GROUP BY YEAR(end_date)";
                  $result = $conn->query($sql);
                  while($row = $result->fetch_assoc()) {
                    if(in_array($row['year'], $labels)) {
                      $index = array_search($row['year'], $labels);
  ...
  <script>
    ...
    if (isset($_GET['filterType']) && $_GET['filterType'] == "quarter") {
      ...
      $yearFilter = $_GET['annual'];
      if (isset($_GET['annual']) && $_GET['annual'] != "none") {
        $sql = "SELECT QUARTER(`rt`.`end_date`) AS `quarter`, SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `rt`.`partnership` = 'Externaly Funded' AND `added_by` = $id AND YEAR(`rt`.`end_date`) = '$yearFilter' AND NOT `status` LIKE 'For Evaluation' GROUP BY `quarter`";
        $sql2 = "SELECT QUARTER(`rt`.`end_date`) AS `quarter`, SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `rt`.`partnership` = 'Institutionaly Funded' AND `added_by` = $id AND YEAR(`rt`.`end_date`) = '$yearFilter' AND NOT `status` LIKE 'For Evaluation' GROUP BY `quarter`";
      } else {
        $sql = "SELECT QUARTER(`rt`.`end_date`) AS `quarter`, SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `rt`.`partnership` = 'Externaly Funded' AND `added_by` = $id AND NOT `status` LIKE 'For Evaluation' GROUP BY `quarter`";
        $sql2 = "SELECT QUARTER(`rt`.`end_date`) AS `quarter`, SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `rt`.`partnership` = 'Institutionaly Funded' AND `added_by` = $id AND NOT `status` LIKE 'For Evaluation' GROUP BY `quarter`";
      }
      $result = $conn->query($sql);
      while($row = $result->fetch_assoc()) {
        if(in_array($row['quarter'], $labels)) {
      ...
      $labels = $yearArray;
      $data = array("0", "0", "0", "0", "0");
      $sql = "SELECT YEAR(`rt`.`end_date`) AS `year`, SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `rt`.`partnership` = 'Externaly Funded' AND `added_by` = $id AND NOT `status` LIKE 'For Evaluation' GROUP BY `year`";
      $sql2 = "SELECT YEAR(`rt`.`end_date`) AS `year`, SUM(`e`.`quantity` * `e`.`unit_cost`) AS `total` FROM `research_topic` AS `rt` INNER JOIN `expenses` AS `e` ON `rt`.`id` = `e`.`research_topic_id` WHERE `rt`.`partnership` = 'Institutionaly Funded' AND `added_by` = $id AND NOT `status` LIKE 'For Evaluation' GROUP BY `year`";
      $result = $conn->query($sql);
      while($row = $result->fetch_assoc()) {
        if(in_array($row['year'], $labels)) {
          $index = array_search($row['year'], $labels);
            ...
            datasets: [{
              ...
              data: [
                ...
                if (isset($_GET['filterType']) && $_GET['filterType'] == "quarter") {
                  ...
                  $yearFilter = $_GET['annual'];
                  if (isset($_GET['annual']) && $_GET['annual'] != "none") {
                    $sql = "SELECT QUARTER(date_inventions) AS quarter, COUNT(*) AS total FROM `inventions` WHERE added_by = $id AND YEAR(date_inventions) = '$yearFilter' GROUP BY QUARTER(date_inventions)";
                  } else {
                    $sql = "SELECT QUARTER(date_inventions) AS quarter, COUNT(*) AS total FROM `inventions` WHERE added_by = $id GROUP BY QUARTER(date_inventions)";
                  }
                  $result = $conn->query($sql);
                  while($row = $result->fetch_assoc()) {
                    if(in_array($row['quarter'], $labels)) {
                  ...
                  $labels = $yearArray;
                  $data = array("0", "0", "0", "0", "0");
                  $sql = "SELECT YEAR(date_inventions) AS year, COUNT(*) AS total FROM `inventions` WHERE added_by = $id GROUP BY YEAR(date_inventions)";
                  $result = $conn->query($sql);
                  while($row = $result->fetch_assoc()) {
                    if(in_array($row['year'], $labels)) {
                      $index = array_search($row['year'], $labels);
