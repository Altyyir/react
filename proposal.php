				                ...
				                <table id="example5" class="display">
				                    ...
				                    <tbody>
				                    	...
				                    	while($row = mysqli_fetch_array($result1)) {
				                    	 ?>
				                	 	<tr>
					                  	   <td style="display: none;" class='center-align px-3'><strong><?php echo $count?></strong></strong></td>
									...
									<div class="modal-content">
										...
										<div class="modal-footer">
											<div class="d-flex project-image">
												...
												<button type="button" class="btn btn-primary" style="margin: 5px;" onclick="addComment(`<?=$row['id']?>`)">Send </button>
											</div>
										</div>
									</div>
								</div>
