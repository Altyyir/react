...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  $sql = "INSERT INTO conferences (themetitle, organizer, conference_title, venue, participation, conference, from_conference, to_conference, added_by) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
  $stmt = mysqli_prepare($conn, $sql);

  if ($stmt) {
    mysqli_stmt_bind_param($stmt, "sssssssss", $themetitle, $organizer, $conference_title, $venue, $participation, $conference, $from_conference, $to_conference, $user_id);
    if (mysqli_stmt_execute($stmt)) {
      // $user_id = $_SESSION['user_id'];
      // $category = "conferences";
      // $description = "has added his/her conferences.";
      // $sql = "INSERT INTO `notification`(`user_id`, `category`, `description`) VALUES (?, ?, ?)";
      // $stmt = mysqli_stmt_init($conn);
      // if (!mysqli_stmt_prepare($stmt, $sql)) {
      //   header("location: ./conferences.php?error");
      //   exit();
      // }
...
<body>
        ...
        <div class="row page-titles">
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="tableconferences.php">Conferences</a>
            </li>
            <li class="breadcrumb-item active">
              <a href="conferences.php">Conferences Attended Form</a>
            </li>
          </ol>
        </div>
        <div class="row">
          <div class="col s12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Conferences Attended Form</h4>
              </div>
              <div class="card-body">
                <form method="post" action="" id="conferences">
                  <div class="row">
                    <div class="col-lg-6 mb-3">
                      <label class="form-label">Theme/Title <span class="text-danger">*</span>
                      </label>
                      <input class="form-control form-control-lg" rows="5" placeholder="Theme/Title" name="themetitle" required></input>
                    </div>
                    <div class="col-lg-6 mb-3">
                      <label class="form-label">Conferences Title <span class="text-danger">*</span>
                      </label>
                      <input class="form-control form-control-lg" rows="5" placeholder="Conferences Title" name="conference_title" required></input>
                    </div>
                    <div class="col-lg-12 mb-3">
                      <label class="form-label">Sponsor <span class="text-danger">*</span>
                      </label>
                      <input class="form-control form-control-lg" rows="5" placeholder="Organizer" name="organizer" required></input>
                    </div>
                    <div class="col-lg-12 mb-3">
                      <label class="form-label">Venue <span class="text-danger">*</span>
                      </label>
                      <input class="form-control form-control-lg" rows="5" placeholder="Venue" name="venue" required></input>
                    </div>
                    <div class="col-lg-6 mb-3">
                      <label class="form-label">Type of Participation <span class="text-danger">*</span>
                      </label>
                      <select id="inputState" class="default-select form-control default-select wide" name="participation" required>
                    ...
                    <div class="col-lg-6 mb-3">
                      ...
                      <select class="default-select form-control default-select wide" name="conference" required>
                    ...
                    <div class="col-lg-6 mb-3">
                      ...
                      <input type="date" value="" class="form-control form-control-lg" name="from_conference" required>
                    </div>
                    <div class="col-lg-6 mb-3">
                      <label class="form-label">To <span class="text-danger">*</span>
                      </label>
                      <input type="date" value="" class="form-control form-control-lg" name="to_conference" required>
                    </div>
                    <div class="col-md-2" style="margin-top: 10px;">
                      <button type="submit" class="btn btn-primary mb-2">Submit</button>
                      <a href="tableconferences.php" type="button" class="btn btn-danger light" data-bs-dismiss="modal">Close</a>
                    </div>
                  </div>
                </form>
              </div>
  ...
  <script>
    document.getElementById("conferences").addEventListener("submit", function(e) {
    ...
    function showAlert() {
      swal({
        ...
        document.getElementById("conferences").submit();
      });
