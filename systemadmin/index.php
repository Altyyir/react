        ...
        ***********************************-->
		<div class="content-body">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<!-- <div class="profile card card-body px-3 pt-3 pb-0" style="margin-top: 60px"> -->
						<div class="profile-head">
							<!-- <div class="row"> -->
							<div class="profile-info justify-content-center">
								<div class="profile-photo" style="width: 326px; margin-top: 1.5rem">
									<img src="images/bsu.png" style="aspect-ratio: 0;" class="img-fluid rounded-circle" alt="">
								</div>
							</div>
							<!-- </div>-->
							<div class="row" style="margin-top: 0px auto;">
								<h4 style="font-size:25px; text-align: center; font-weight:600">BATANGAS STATE UNIVERSITY</h4>
							</div>
						</div>
						<!-- </div> -->
					</div>
                    ...
                    <div class="profile card card-body px-3 pt-3 pb-0" style="margin-top: 60px">
                        <div class="profile-head">
                                <div class="profile-info justify-content-center">
									<div class="profile-photo" style="max-width: 10.5rem; margin-top: -6.5rem">
									  <img src="images/bsu.png" style="aspect-ratio: 0;" class="img-fluid rounded-circle" alt="">
									</div>
                                </div>
                            <div class="row" style="margin-top: 0px auto;">
								<h4 style="font-size:25px; text-align: center;">Asst. Prof. Noelyn De Jesus</h4>
							</div>
							<div class="row">
								<h4 style="font-size:19px; text-align: center;">Asst. Prof. Noelyn De Jesus</h4>
							</div>
                    	</div>
                    </div>
                </div> -->
