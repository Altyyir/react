...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  if ($row = $result->fetch_assoc()) {
    header("location: ./adduser.php?invalid=1"); // invalid = 1 kapag may existing na email sa database
    exit();
  }

  $sql = "INSERT INTO `faculty_user`(`title`, `first_name`, `middle_name`, `last_name`, `gender`, `email`, `password`, `college_id`, `status`, `authority`, `image_path`) VALUES ('$title','$first_name','$middle_name','$last_name','$gender','$email','$password',$college,'1','$privelege','/images/profile.jpeg')";
  if ($conn->query($sql)) {
      ...
      <div class="container-fluid">
        <div class="row page-titles">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="addUser.php">Create User</a></li>
          </ol>
        </div>
        <div class="row">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="basic-form">
                  <form method="post" action="addUser.php" id="user">
                    <div class="row">
                      ...
                      <div class="mb-3 col-md-3">
                        ...
                        <input type="text" class="form-control form-control-lg" placeholder="Middle Name" name="middle_name" required>
                      </div>
                      <div class="mb-3 col-md-3">
                ...
                <div class="col-md-2" style="margin-top: 10px;">
                  <button type="button" class="btn btn-primary mb-2" onclick="showAlert()">Submit</button>
