...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  $sql = "INSERT INTO employment (agency, plantilla_position, status, appointment_start, appointment_end, monthly_salary, added_by) VALUES (?, ?, ?, ?, ?, ?, ?)";
  $stmt = mysqli_prepare($conn, $sql);

  if ($stmt) {
    mysqli_stmt_bind_param($stmt, "sssssss", $agency, $plantilla_position, $status, $appointment_start, $appointment_end, $monthly_salary, $user_id);
    if (mysqli_stmt_execute($stmt)) {
      // $user_id = $_SESSION['user_id'];
      // $category = "employment";
      // $description = "has added his/her employment.";
      // $sql = "INSERT INTO `notification`(`user_id`, `category`, `description`) VALUES (?, ?, ?)";
      // $stmt = mysqli_stmt_init($conn);
      // if (!mysqli_stmt_prepare($stmt, $sql)) {
      //   header("location: ./employment.php?error");
      //   exit();
      // }
        ...
        <div class="row page-titles">
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="tableemployment.php">Employment</a>
            </li>
            <li class="breadcrumb-item active">
              <a href="academicbackground.php">Employment Form</a>
            </li>
          </ol>
        </div>
        <div class="row">
          <div class="col s12">
            <div class="card">
              ...
              <div class="card-body">
                <form method="post" action="#" id="employment">
                  <div class="row">
                    <div class="col-lg-6 mb-3">
                      <label class="form-label ">Agency <span class="text-danger">*</span></label>
                      <input class="form-control form-control-lg" rows="5" placeholder="Agency" name="agency" required></input>
                    </div>
                    <div class="col-lg-6 mb-3">
                      <label class="form-label ">Plantilla Position <span class="text-danger">*</span>
                      </label>
                      <input class="form-control form-control-lg" rows="5" placeholder="Plantilla Position" name="plantilla_position" required></input>
                    </div>
                    ...
                    <div class="col-md-2" style="margin-top: 10px;">
                      ...
                      <a href="tableemployment.php" type="button" class="btn btn-danger light" data-bs-dismiss="modal">Close</a>
                    </div>
                  </div>
                </form>
              </div>
...
***********************************-->
  ...
  <script>
    document.getElementById("employment").addEventListener("submit", function(e) {
