...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  $date_inventions = $_POST['date_inventions'];
  $country = $_POST['country'];
  $ipo_registration = $_POST['ipo_registration'];

  $sql = "INSERT INTO inventions (title, right_type, patent_no, principal_author, date_inventions, country, ipo_registration, added_by) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
  $stmt = mysqli_prepare($conn, $sql);

  if ($stmt) {
    mysqli_stmt_bind_param($stmt, "ssssssss", $title, $right_type, $patent_no, $principal_author, $date_inventions, $country, $ipo_registration, $user_id);
    if (mysqli_stmt_execute($stmt)) {
      $user_id = $_SESSION['user_id'];
      $category = "inventions";
      $description = "has added his/her inventions.";
      $sql = "INSERT INTO `notification`(`user_id`, `category`, `description`) VALUES (?, ?, ?)";
      $stmt = mysqli_stmt_init($conn);
      if (!mysqli_stmt_prepare($stmt, $sql)) {
        header("location: ./inventions.php?error");
        exit();
      }
        ...
        <div class="row page-titles">
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="tableinventions.php">Inventions</a>
            </li>
            <li class="breadcrumb-item active">
              <a href="inventions.php">Inventions Form</a>
            </li>
          </ol>
        </div>
        <div class="row">
          <div class="col s12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Inventions Form</h4>
              </div>
              <div class="card-body">
                <form method="post" action="" id="inventions">
                  <div class="row">
                    ...
                    <div class="col-lg-6 mb-3">
                      ...
                      <select class="default-select form-control default-select wide" name="right_type" required>
                        <option value="">Choose IP Right</option>
                    ...
                    <div class="col-lg-6 mb-3">
                      ...
                      <input class="form-control form-control-lg" rows="5" placeholder="Patent No." name="patent_no" required></input>
                    </div>
                    <div class="col-lg-12 mb-3">
                      <label class="form-label">Principal Author/Inventor <span class="text-danger">*</span>
                      </label>
                      <input class="form-control form-control-lg" rows="5" placeholder="Last Name, First Name, Middle Name" name="principal_author" required></input>
                    </div>
                    <div class="col-lg-6 mb-3">
                      <label class="form-label">Date Issued <span class="text-danger">*</span>
                      </label>
                      <input type="date" class="form-control form-control-lg" rows="5" name="date_inventions" required></input>
                    </div>
                    <div class="col-lg-6 mb-3">
                      <label class="form-label">Country</label>
                      <select class="default-select form-control default-select wide" name="country">
                    ...
                    <div class="col-lg-12 mb-3">
                      <label class="form-label">Upload Proof of IPO registration:<span class="text-danger">*</span></label>
                      <input type="file" class="form-control form-control-lg" rows="5" name="ipo_registration" style="padding-top: 10px;" accept=".pdf" required></input>
                    </div>
                    <div class="col-md-2" style="margin-top: 10px;">
                      <button type="submit" class="btn btn-primary mb-2">Submit</button>
                      <a href="tableinventions.php" type="button" class="btn btn-danger light" data-bs-dismiss="modal">Close</a>
                    </div>
                  </div>
                </form>
              </div>
...
<script src="js/plugins-init/sweetalert.init.js"></script> -->
  ...
  <script>
    document.getElementById("inventions").addEventListener("submit", function(e) {
    ...
    function showAlert() {
      swal({
        ...
        document.getElementById("inventions").submit();
      });
