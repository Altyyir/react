    ...
    if(isset($_GET['id']))
        {
            ...
            if(isset($_POST['editSpecialization'])) {
                ...
                echo $specialization = $_POST['updateSpecialization'];
                echo $primary_field = $_POST['updatePrimary_field'];
...
<!--                                <input type="text" class="form-control" placeholder="Search here...">
                                ...
                                <div class="mb-4">
                                    <a href="specialization.php" type="button" class="btn btn-primary btn-rounded fs-16"><i class="fas fa-plus me-3 scale4" style="color: #fff;"></i>Add Field of Specialization</a>
                                  </div>
                            </div>
                        </div>
                    </div>              
                                ...
                                <table id="example5" class="display">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="col-md-4"><strong>Field of Specialization</strong></th>
                                    ...
                                    <tbody>
                                        <?php 
                                            $query = "SELECT * FROM specialization WHERE added_by = {$user_id} ORDER BY `id` DESC";
                                        ...
                                        <tr>
                                           ...
                                           <td class="col-md-4"><?php echo $row["specialization"]?></td>
                                                    ...
                                                    <div id="edit-modal-<?=$row['id']?>" class="modal fade bd-example-modal-lg">
                                                        <div class="modal-dialog modal-lg ">
                                                            <div class="modal-content">
                                                                <form method="post" action="edit.specialization.php">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                        <div class="col-lg-12">
                                                                          ...
                                                                          <div class="row">
                                                                           <div class="col-md-10">
                                                                             <input type="text" class="form-control form-control-lg" name="specialization" value="<?=$row['specialization']?>" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;" required>

                                                                           </div>
                                                                           <div class="col-md-2">
                                                                             <select class="default-select form-control default-select wide" name="primary_field" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;" required>

                                                                             <option <?php if($row['primary_field'] == 'Yes'){echo "selected";}?>>Yes</option>
                                                                             <option <?php if($row['primary_field'] == 'No'){echo "selected";}?>>No</option>
                                                                            </select>
                                                                           </div>
                                                                          </div>
                                                                          <!-- /# card -->
  ...
  <script src="vendor/datatables/js/jquery.dataTables.min.js"></script>
    ...
    <script>
      function setData(q, w, r) {
        ...
        document.getElementById('updateSpecialization').value = w;
        document.getElementById('updatePrimary_field').value = r;
      }
    </script>
    <script>
        function deleteRecord(e) {
            ...
            .then((result) => {
              if(result) {
                ...
                deleteRecord.open("GET", "delete.record.php?table=specialization&id="+e); // yung pangalan lang ng table ang papalitan
                deleteRecord.send();
