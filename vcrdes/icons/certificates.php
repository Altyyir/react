...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['addcertificate'])) {
        ...
        $title = mysqli_real_escape_string($conn, $_POST['certificate']);
        $link = mysqli_real_escape_string($conn, $_POST['link']);

        // Handle image upload
        $target_dir = 'certificate_upload/'; // Directory where you want to store uploaded images
        ...
        if (move_uploaded_file($_FILES['file']['tmp_name'], $target_file)) {
            ...
            $sql = "INSERT INTO certificates (title, link, image_path) VALUES ('$title', '$link', '$fileName')";

            if (mysqli_query($conn, $sql)) {
                // Certificate added successfully
                header('Location: certificates.php'); // Redirect to a success page or wherever you want
                exit();
            } else {
      ...
      <div class="col-lg-12">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
          <div class="page-titles" style="width:355px">
            <ol class="breadcrumb">
              <li class="breadcrumb-item">
                <a href="createfolder.php?college=cics">Repository Folder</a>
              </li>
          ...
          <div class="mb-4">
                                  ...
                                  <div id="annualFilterRow" class="col-lg-12 mb-3" style="display: none;">
                                   <label class="form-label">Filter by
                                    ...
                                    <select id="annualFilterInput" class="form-control" name="annual">
                                        ...
                                        <?php
                                        $sql = "SELECT DISTINCT(YEAR(dateAdded)) AS year FROM research_topic ORDER BY dateAdded DESC";
                                        $result = $conn->query($sql);
              ...
              <!-- <div class="mb-4">
                <button type="button" class="btn btn-primary btn-rounded fs-16" data-bs-toggle="modal" data-bs-target="#exampleModalCenter"><i class="fas fa-cloud-upload-alt me-3 scale4" style="color: #fff;"></i>Upload Certificates</a></button>
              </div>
                    ...
                    <div class="table-responsive">
                      <table id="example" class="display">
                        ...
                        <tbody>
                          <?php
                              $folderID = $_GET['id'];
                              $sql = "SELECT c.*, fu.title, fu.first_name, fu.middle_name, fu.last_name, fu.image_path AS profile_pic FROM certificates AS c INNER JOIN faculty_user AS fu ON c.added_by = fu.id WHERE create_folder_id = $folderID ORDER BY id DESC";
                          ...
                          <tr>
                            ...
                            <td class="col-md-3">
                                <img src="images/pdf.png" width="18" alt="" style="margin-right: 5px;"> <?= $row['image_path'] ?>
                            </td>
                            ...
                            <td class="col-md-3" style="text-align: center;">
                                <img src="<?php if($row['profile_pic'] == ""){echo "images/bsu.png";}else{echo $row['profile_pic'];}?>" width="25" alt="" style="margin-right: 5px; border-radius: 13px;"> <?=$row['title']." ".$row['first_name']." ".$row['middle_name']." ".$row['last_name']?> 
                            </td>
                            <td class="col-md-2">
                              <div class="d-flex justify-content-center">
                                  <div class="d-flex">
                                      <!-- <a onclick="deleteRecord(`<?=$row['id']?>`)" class="btn btn-dark shadow btn-xs sharp me-1" title="Delete"><i class="fas fa-trash"></i></a> -->
                                      <a class="btn btn-dark shadow btn-xs sharp me-1" href="../certificate_upload/<?=$row['image_path']?>" target="_blank" title="View"><i class="fas fa-eye"></i></a>
                                  </div>
                              </div>
                            </td>
                          </tr>
                            <?php
                              ...
                              elseif($folderID == "null" && isset($folderName)) :
                                ...
                                // Remove the "." and ".." entries from the list (current directory and parent directory)
