            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="example" class="display">
                  ...
                  <tbody>
                    <?php
                    $query = "SELECT per.id, per.award, per.category, per.granting_institution, per.year_granted, fac.title, fac.first_name, fac.middle_name, fac.last_name FROM award AS per INNER JOIN faculty_user AS fac ON per.added_by = fac.id ORDER BY id DESC";
