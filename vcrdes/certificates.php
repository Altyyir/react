                        ...
                        <tbody>
                          <?php
                              ...
                              if(isset($_GET['annual'])) {
                                if($_GET['annual'] != "none") {
                                  $annual = $_GET['annual'];
                                  $year = " AND YEAR(c.date_added) = '$annual' ";
                                } else {
                                  $year = "";
                                }

                                $sql = "SELECT c.*, fu.title, fu.first_name, fu.middle_name, fu.last_name, fu.image_path AS profile_pic FROM certificates AS c INNER JOIN faculty_user AS fu ON c.added_by = fu.id WHERE create_folder_id = $folderID ".$year." ORDER BY id DESC";
                              } else {
                          ...
                          <tr>
                            ...
                            <td class="col-md-3" style="text-align: center;">
                            <img src="../profile_upload/<?php if($row['profile_pic'] == ""){echo "images/bsu.png";}else{echo $row['profile_pic'];}?>" width="25" alt="" style="margin-right: 5px; border-radius: 13px;"> <?=$row['title']." ".$row['first_name']." ".$row['middle_name']." ".$row['last_name']?> 
                            </td>
                            <td class="col-md-2">
