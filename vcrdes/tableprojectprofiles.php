                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="example" class="display">
                                    ...
                                    <tbody>
                                        <?php 
                                                $query = "SELECT per.id, per.titleproject, per.typefundinginstitution, per.from_project, per.to_project, per.status, per.file, fac.title, fac.first_name, fac.middle_name, fac.last_name FROM project_profile AS per INNER JOIN faculty_user AS fac ON per.added_by = fac.id ORDER BY id DESC";
