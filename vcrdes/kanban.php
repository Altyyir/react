...
if(isset($_POST['submit'])){
	...
	$sql = "INSERT INTO `research_topic`(`Id`, `title`, `agenda`, `partnership`, `sponsor`, `developmentGoal`, `agency`, `college`, `department`, `startDate`, `endDate`, `female`, `male`) VALUES (NULL,'$title','$agenda','$partnership','$sponsor','$goal1','$agency','$college','$department','$startDate','$endDate','$female','$male')";
