...
<div class="col-md-2 mb-5">
  <div class="folder">
    <a href="createfolder.php?college=cabeihm">
      <img src="images/bsu_folder.png" style="width:150px">        
    </a>
    <div class="card-footer mb-2" style="width:140px; max-height: 50px; overflow: hidden; padding: 10px; text-align: center;">CABEIHM
  </div>
  </div>
</div>
...
<div class="col-md-2 mb-5">
  <div class="folder">
    <a href="createfolder.php?college=cas">
      <img src="images/bsu_folder.png" style="width:150px">        
    </a>
    <div class="card-footer mb-2" style="width:140px; max-height: 50px; overflow: hidden; padding: 10px; text-align: center;">CAS
  </div>
  </div>
</div>
...
<div class="col-md-2 mb-5">
  <div class="folder">
    <a href="createfolder.php?college=cics">
      <img src="images/bsu_folder.png" style="width:150px">        
    </a>
    <div class="card-footer mb-2" style="width:140px; max-height: 50px; overflow: hidden; padding: 10px; text-align: center;">CICS
  </div>
  </div>
</div>
...
<div class="col-md-2 mb-5">
  <div class="folder">
    <a href="createfolder.php?college=conahs">
      <img src="images/bsu_folder.png" style="width:150px">        
    </a>
    <div class="card-footer mb-2" style="width:140px; max-height: 50px; overflow: hidden; padding: 10px; text-align: center;">CONAHS
  </div>
  </div>
</div>
...
<div class="col-md-2 mb-5">
  <div class="folder" oncontextmenu="showContextMenu(event, <?php echo $row['id']; ?>)">
    <a href="createfolder.php?college=cte">
      <img src="images/bsu_folder.png" style="width:150px">        
    </a>
    <div class="card-footer mb-2" style="width:140px; max-height: 50px; overflow: hidden; padding: 10px; text-align: center;">CTE
  </div>
  </div>
</div>
...
$sql = "SELECT * FROM create_folder ORDER BY id DESC";
