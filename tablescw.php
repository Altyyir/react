                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-4 mb-3">
                                                                             ...
                                                                             <select id="inputState" class="form-control form-control-lg" name="principal_author" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;">
                                                                              ...
                                                                              <option <?php if($row['principal_author'] == 'Yes'){echo "selected";}?>>Yes</option>
                                                                              <option <?php if($row['principal_author'] == 'No'){echo "selected";}?>>No</option>
                                                                            </select>
                                                                        </div>
                                                                        <div class="col-lg-4 mb-3">
                                                                            ...
                                                                            <select id="inputState" class="default-select form-control default-select wide" name="type" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;" required>
                                                                              ...
                                                                              <option <?php if($row['type'] == 'Creative Work'){echo "selected";}?>>Creative Work</option>
                                                                              <option <?php if($row['type'] == 'Journal'){echo "selected";}?>>Journal</option>
                                                                              <option <?php if($row['type'] == 'Proceeding'){echo "selected";}?>>Proceeding</option>
                                                                              <option <?php if($row['type'] == 'Orginal Design'){echo "selected";}?>>Orginal Design</option>
                                                                              <option> <?php if($row['type'] == 'Techhinical Papers'){echo "selected";}?>Techhinical Papers</option>
                                                                        ...
                                                                        <div class="col-lg-6 mb-3">
                                                                            <label class="form-label">Class <span class="text-danger">*</span>
                                                                             ...
                                                                             <select id="inputState" class="default-select form-control default-select wide" name="class" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;">
                                                                              ...
                                                                              <option <?php if($row['class'] == 'Refereed'){echo "selected";}?>>Refereed</option>
                                                                              <option <?php if($row['class'] == 'Non-Refereed'){echo "selected";}?>>Non-Refereed</option>
                                                                              <option <?php if($row['class'] == 'Refereed ISI'){echo "selected";}?>>Refereed ISI</option>
                                                                            </select>
                                                                        </div>
                                                                        <div class="col-lg-6 mb-3">
                                                                            <label class="form-label">Level<span class="text-danger">*</span>
                                                                             ...
                                                                             <select id="inputState" class="default-select form-control default-select wide" name="level" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;">
                                                                              ...
                                                                              <option <?php if($row['level'] == 'International'){echo "selected";}?>>International</option>
                                                                              <option <?php if($row['level'] == 'National'){echo "selected";}?>>National</option>
                                                                            </select>
                                                                        </div>
                                                                        <div class="col-lg-6 mb-3">
                                                                            <label class="form-label">Publication Group 
                                                                              ...
                                                                              <select id="inputState" class="default-select form-control default-select wide" name="publication_group" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;">
                                                                                  ...
                                                                                  <option <?php if($row['publication_group'] == 'R&D Papers in Scientific Journals'){echo "selected";}?>>R&D Papers in Scientific Journals</option>
                                                                                  <option <?php if($row['publication_group'] == 'Technical Reports'){echo "selected";}?>>Technical Reports</option>
                                                                                  <option <?php if($row['publication_group'] == 'Research Abstracts'){echo "selected";}?>>Research Abstracts</option>
                                                                                  <option <?php if($row['publication_group'] == 'Papers Presented in Conferences'){echo "selected";}?>>Papers Presented in Conferences</option>
                                                                                  <option <?php if($row['publication_group'] == 'Books'){echo "selected";}?>>Books</option>
                                                                                  <option <?php if($row['publication_group'] == 'News Articles'){echo "selected";}?>>News Articles</option>
                                                                                  <option <?php if($row['publication_group'] == 'Others'){echo "selected";}?>>Others</option>
                                                                                </select>
                                                                          </div>
                                                                          <div class="col-lg-6 mb-3">
                                                                            <label class="form-label">Authoring Type 
                                                                              ...
                                                                              <select id="inputState" class="default-select form-control default-select wide" name="authoring_type" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;">
                                                                                  ...
                                                                                  <option <?php if($row['authoring_type'] == 'Sole-Author'){echo "selected";}?>>Sole-Author</option>
                                                                                  <option <?php if($row['authoring_type'] == 'Co-Author'){echo "selected";}?>>Co-Author</option>
                                                                                  <option <?php if($row['authoring_type'] == 'Editor'){echo "selected";}?>>Editor</option>
                                                                                  <option <?php if($row['authoring_type'] == 'Co-Editor'){echo "selected";}?>>Co-Editor</option>
                                                                                  <option <?php if($row['authoring_type'] == 'Main Author'){echo "selected";}?>>Main Author</option>
                                                                                  <option <?php if($row['authoring_type'] == 'Others'){echo "selected";}?>>Others</option>
                                                                                </select>
                                                                          </div>
                                                                                                                    </div>
                                                                    <div class="row">
