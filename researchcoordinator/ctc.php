...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  $sql = "INSERT INTO ctc (title_ctc, organizer_ctc, venue_ctc, conference_ctc, from_ctc, to_ctc, added_by) VALUES (?, ?, ?, ?, ?, ?, ?)";
  $stmt = mysqli_prepare($conn, $sql);

  if ($stmt) {
    mysqli_stmt_bind_param($stmt, "sssssss", $title_ctc, $organizer_ctc, $venue_ctc, $conference_ctc, $from_ctc, $to_ctc, $user_id);
...
<body>
        ...
        <nav class="navbar navbar-expand">
          <div class="collapse navbar-collapse justify-content-between">
            <div class="header-left">
              <div class="dashboard_bar">Capability Training Conducted</div>
            </div>
        ...
        <div class="row page-titles">
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="tablectc.php">Capability Training Conducted</a>
            </li>
            <li class="breadcrumb-item active">
              <a href="ctc.php">Capability Training Conducted Form</a>
            </li>
          </ol>
        </div>
        <div class="row">
          <div class="col s12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Capability Training Conducted Form</h4>
              </div>
              <div class="card-body">
                <form method="post" action="" id="ctc">
                  <div class="row">
                    <div class="col-lg-12 mb-3">
                      <label class="form-label">Theme/Title <span class="text-danger">*</span>
                      </label>
                      <input class="form-control form-control-lg" rows="5" placeholder="Theme/Title" name="title_ctc" required></input>
                    </div>
                    <div class="col-lg-12 mb-3">
                      <label class="form-label">Venue <span class="text-danger">*</span>
                      </label>
                      <input class="form-control form-control-lg" rows="5" placeholder="Venue" name="venue_ctc" required></input>
                    </div>
                    <div class="col-lg-6 mb-3">
                      <label class="form-label">Level of Capability Training <span class="text-danger">*</span>
                      </label>
                      <select class="form-control" name="conference_ctc" required>
                    ...
                    <div class="col-lg-6 mb-3">
                      ...
                      <select class="form-control" name="organizer_ctc" required>
                        <option value="">Choose Organizer</option>
                        <option>Batangas State University</option>
                    ...
                    <div class="col-lg-6 mb-3">
                      ...
                      <input type="date" value="" class="form-control form-control-lg" name="from_ctc" required>
                    </div>
                    <div class="col-lg-6 mb-3">
                      <label class="form-label">To <span class="text-danger">*</span>
                      </label>
                      <input type="date" value="" class="form-control form-control-lg" name="to_ctc" required>
                    </div>
                    <div class="col-md-2" style="margin-top: 10px;">
                      <button type="submit" class="btn btn-primary mb-2">Submit</button>
                      <a href="tablectc.php" type="button" class="btn btn-danger light" data-bs-dismiss="modal">Close</a>
                    </div>
                  </div>
                </form>
              </div>
  ...
  <script>
    document.getElementById("ctc").addEventListener("submit", function(e) {
    ...
    function showAlert() {
      swal({
        ...
        document.getElementById("ctc").submit();
      });
