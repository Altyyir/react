                    ...
                    <table id="example" class="display">
                      <thead>
                        <tr>
                          ...
                          <th class="col-md-2"><strong>Main Author</strong></th>
                      ...
                      <tbody>
                        ...
                        $query = "SELECT per.id, per.title, per.main_author, per.year_published, per.publisher, per.url FROM scw_ AS per INNER JOIN faculty_user AS fac ON per.added_by = fac.id WHERE fac.college_id = $college ORDER BY id DESC";
                        ...
                        ?>
                          <tr>
                            ...
                            <td class="col-md-2" style="text-align: center;"><span style="width: 150px; display: block"><a href="<?php echo $row["url"]; ?>" style="color: blue" target="_blank"><?php echo $row["url"]; ?></a></span></td>
                          </tr>
                        <?php
                        }
                        ?>
