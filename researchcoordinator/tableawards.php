                ...
                <table id="example" class="display">
                  <thead>
                    <tr>
                      ...
                      <th class="col-md-3" style="text-align: center;"><strong>Title of R&D Award</strong></th>
                      ...
                      <th class="col-md-1" style="text-align:center;"><strong>Year Granted</strong></th>
                  ...
                  <tbody>
                    ...
                    $query = "SELECT per.id, per.award, per.category, per.granting_institution, per.year_granted, fac.title, fac.first_name, fac.middle_name, fac.last_name FROM award AS per INNER JOIN faculty_user AS fac ON per.added_by = fac.id WHERE fac.college_id = $college ORDER BY id DESC";
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="col-md-1" style="text-align: center;"><?php echo $year_granted_formatted; ?></td>
                        <!-- <td class="col-md-1">
                                            <div class="d-flex" >
                                                <div class="d-flex">
                                                                           ...
                                                                           <div class="row">
                                                                              <div class="col-xl-12">
                                                                                <div class="d-flex justify-content-between flex-wrap">
                                                                                  <div class="input-group contacts-search mb-8">
                                                                                    <h2 style="margin-left: 27px; margin-top: -3px; font-size: 19px; font-weight: 600; color: #000;">R&D Awards</h2>
                                                                            ...
                                                                            <div class="col-lg-10 mb-3">
                                                                              <label class="form-label ">Title of R&D Award <span class="text-danger">*</span>
                                                                               ...
                                                                               <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Title of R&D Award" name="award"></input>
                                                                            </div>
                                                                            <div class="col-lg-2 mb-3">
                                                                              <label class="form-label ">Rank <span class="text-danger">*</span>
                                                                              </label>
                                                                               <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Rank" name="rank"></input>
                                                                            </div>
                                                                            <div class="col-lg-6 mb-3">
                                                                              <label class="form-label ">Category <span class="text-danger">*</span>
                                                                               ...
                                                                               <select id="inputState" class="default-select form-control default-select wide" name="category" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;" required>
                                                                                  ...
                                                                                  <option>Local - In-house</option>
                                                                                  <option>Local – Regional</option>
                                                                                  <option>Local – National</option>
                                                                            ...
                                                                            <div class="col-lg-6 mb-3">
                                                                              <label class="form-label ">Year Granted <span class="text-danger">*</span>
                                                                                ...
                                                                                <input type="date" value="" class="form-control form-control-lg" name="year_granted" required>
                                                                            </div>
                                                                            <div class="col-lg-12 mb-3">
                                                                              <label class="form-label ">Granting Institution <span class="text-danger">*</span>
                                                                              </label>
                                                                               <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Granting Institution" name="granting_institution"></input>
                                                                            </div>
                                                                    </div> 
                                                                </div>
                                                ...
                                                <a href="tableawards.php?id=<?php echo $row['id']; ?>" class="btn btn-dark shadow btn-xs sharp me-1"><i class="fas fa-trash"></i></a>
                                            </div> -->
