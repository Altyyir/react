                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-md-6 mb-3">
                                            ...
                                            <select id="inputState" class="form-control" name="organizer_ctc" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;">
                                              ...
                                              <option <?php if ($row['organizer_ctc'] == 'Batangas State University') {
                                                        echo "selected";
                                                      } ?>>Batangas State University</option>
                                              <option <?php if ($row['organizer_ctc'] == 'Others') {
                                                        echo "selected";
                                                      } ?>>Others</option>
                                            </select>
                                          </div>
                                          <div class="col-lg-6 mb-3">
                                            ...
                                            <select id="inputState" class="form-control" name="conference_ctc" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;">
                                              ...
                                              <option <?php if ($row['conference_ctc'] == 'Local') {
                                                        echo "selected";
                                                      } ?>>Local</option>
                                              <option <?php if ($row['conference_ctc'] == 'International') {
                                                        echo "selected";
