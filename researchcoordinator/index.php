                                                ...
                                                $college = $_SESSION['college'];
                                                    if(isset($_GET['filterType']) && $_GET['filterType'] == "quarter") {
                                                        if(isset($_GET['quarter']) && $_GET['quarter'] == "first") {
                                                            $yearFilter = $_GET['annual'];
                                                            if(isset($_GET['annual']) && $_GET['annual'] != "none") {
                                                                $sql = "SELECT COUNT(*) AS `total` FROM `scw_` AS con INNER JOIN faculty_user AS fac ON con.added_by = fac.id WHERE fac.college_id = $college AND MONTH(dateAdded) BETWEEN 1 and 3 AND YEAR(dateAdded) = '$yearFilter'";
                                                            } else {
                                                                $sql = "SELECT COUNT(*) AS `total` FROM `scw_` AS con INNER JOIN faculty_user AS fac ON con.added_by = fac.id WHERE fac.college_id = $college AND MONTH(dateAdded) BETWEEN 1 and 3";
                                                            }
                                                            //
                                                        } elseif(isset($_GET['quarter']) && $_GET['quarter'] == "second") {
                                                            $yearFilter = $_GET['annual'];
                                                            if(isset($_GET['annual']) && $_GET['annual'] != "none") {
                                                                $sql = "SELECT COUNT(*) AS `total` FROM `scw_` AS con INNER JOIN faculty_user AS fac ON con.added_by = fac.id WHERE fac.college_id = $college AND MONTH(dateAdded) BETWEEN 4 and 6 AND YEAR(dateAdded) = '$yearFilter'";
                                                            } else {
                                                                $sql = "SELECT COUNT(*) AS `total` FROM `scw_` AS con INNER JOIN faculty_user AS fac ON con.added_by = fac.id WHERE fac.college_id = $college AND MONTH(dateAdded) BETWEEN 4 and 6";
                                                            }
                                                            //
                                                        } elseif(isset($_GET['quarter']) && $_GET['quarter'] == "third") {
                                                            $yearFilter = $_GET['annual'];
                                                            if(isset($_GET['annual']) && $_GET['annual'] != "none") {
                                                                $sql = "SELECT COUNT(*) AS `total` FROM `scw_` AS con INNER JOIN faculty_user AS fac ON con.added_by = fac.id WHERE fac.college_id = $college AND MONTH(dateAdded) BETWEEN 7 and 9 AND YEAR(dateAdded) = '$yearFilter'";
                                                            } else {
                                                                $sql = "SELECT COUNT(*) AS `total` FROM `scw_` AS con INNER JOIN faculty_user AS fac ON con.added_by = fac.id WHERE fac.college_id = $college AND MONTH(dateAdded) BETWEEN 7 and 9";
                                                            }
                                                            //
                                                        } elseif(isset($_GET['quarter']) && $_GET['quarter'] == "fourth") {
                                                            $yearFilter = $_GET['annual'];
                                                            if(isset($_GET['annual']) && $_GET['annual'] != "none") {
                                                                $sql = "SELECT COUNT(*) AS `total` FROM `scw_` AS con INNER JOIN faculty_user AS fac ON con.added_by = fac.id WHERE fac.college_id = $college AND MONTH(dateAdded) BETWEEN 10 and 12 AND YEAR(dateAdded) = '$yearFilter'";
                                                            } else {
                                                                $sql = "SELECT COUNT(*) AS `total` FROM `scw_` AS con INNER JOIN faculty_user AS fac ON con.added_by = fac.id WHERE fac.college_id = $college AND MONTH(dateAdded) BETWEEN 10 and 12";
                                                            }
                                                        } else {
                                                        ...
                                                        if(isset($_GET['annual']) && $_GET['annual'] != "none") {
                                                            $yearFilter = $_GET['annual'];
                                                            $sql = "SELECT COUNT(*) AS `total` FROM `scw_` AS con INNER JOIN faculty_user AS fac ON con.added_by = fac.id WHERE fac.college_id = $college AND YEAR(dateAdded) = '$yearFilter'";
                                                        } else {
                                                            $sql = "SELECT COUNT(*) AS `total` FROM `scw_` AS con INNER JOIN faculty_user AS fac ON con.added_by = fac.id WHERE fac.college_id = $college";
                                                        }
                                                    } else {
                                                ...
                                                $college = $_SESSION['college'];
                                                    if(isset($_GET['filterType']) && $_GET['filterType'] == "quarter") {
                                                        if(isset($_GET['quarter']) && $_GET['quarter'] == "first") {
                                                            ...
                                                            } else {                                                                $sql = "SELECT COUNT(*) AS `total` FROM `research_topic` WHERE `college_id` = $college AND `status` = 'Approved with notice to proceed' AND MONTH(dateAdded) BETWEEN 1 and 3";
                                                            }
                                                            //
                                                        } elseif(isset($_GET['quarter']) && $_GET['quarter'] == "second") {
                                                            $yearFilter = $_GET['annual'];
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div class="row">
                                            <h1 style="font-size:12px">By number of Publication per Colleges</h1></div>
