                                ...
                                <table id="example" class="display">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="col-md-3" style="text-align: center;"><strong>IP Rights Type</strong></th>
                                    ...
                                    <tbody>
                                        <?php 
                                                ...
                                                $query = "SELECT per.id, per.title AS invention_title, per.right_type, per.principal_author, per.date_inventions, fac.title, fac.first_name, fac.middle_name, fac.last_name FROM inventions AS per INNER JOIN faculty_user AS fac ON per.added_by = fac.id WHERE fac.college_id = $college ORDER BY id DESC";
