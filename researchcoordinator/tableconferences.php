                ...
                <table id="example" class="display">
                  <thead>
                    <tr>
                      ...
                      <th class="col-md-3" style="text-align: center;"><strong>Participation</strong></th>
                  ...
                  <tbody>
                    ...
                    $query = "SELECT per.id, per.themetitle, per.organizer, per.participation, per.from_conference, per.to_conference, fac.title, fac.first_name, fac.middle_name, fac.last_name FROM conferences AS per INNER JOIN faculty_user AS fac ON per.added_by = fac.id WHERE fac.college_id = $college ORDER BY id DESC";
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="col-md-3" style="text-align: center;"><?php echo $row["participation"] ?></td>
                        <?php
