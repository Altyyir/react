              ...
              <div class="table-responsive">
                <table id="example" class="display">
                  ...
                  <tbody>
                    ...
                    $query = "SELECT per.specialization, per.primary_field, fac.title, fac.first_name, fac.middle_name, fac.last_name FROM specialization AS per INNER JOIN faculty_user AS fac ON per.added_by = fac.id WHERE fac.college_id = $college";
