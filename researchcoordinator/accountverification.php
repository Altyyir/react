            ...
            <div class="card-body">
              <div class="">
                <table id="example" class="display">
                  <thead>
                    <tr>
                      <th class="col-md-5"><strong>Full Name</strong></th>
                      <th class="col-md-4"><strong>Email</strong></th>
                      <th style="text-align: right;padding-right: 30px;"><strong>Action</strong></th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                    $collegeID = $_SESSION['college'];
                    $query = "SELECT * FROM faculty_user WHERE status = 0 AND college_id = $collegeID ORDER BY `id` DESC";
                      ...
                      <tr>
                        ...
                        <td style="padding-right: 30px;">
                          ...
                          <div class="row justify-content-end">
                            <a href="verify.account.php?id=<?= $row['id'] ?>" class="btn btn-dark shadow btn-xs sharp me-1"><i class="fas fa-check" title='Approve'></i></a>
                            <a href="reject.account.php?id=<?= $row['id'] ?>" class="btn btn-dark shadow btn-xs sharp me-1"><i class="fas fa-times" title='Disapprove'></i></a>
                          </div>
                        </td>
                      </tr>
                    <?php
