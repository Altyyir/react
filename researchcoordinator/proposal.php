...
$query = "SELECT * FROM research_topic WHERE college_id = $college ORDER BY dateAdded DESC";
                ...
                <table id="example" class="display">
                  <thead>
                    <tr>
                      ...
                      <th class="col-md-2" style="width: 100px; text-align: center;"><strong>Research Funding</strong></th>
                      <th class="col-md-2" style="text-align: center;"><strong>Inclusive Period</strong></th>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="col-md-2" style="text-align: center;"><?php echo $start_date . " - " . $end_date; ?></td>
                        <?php
                        $namesArray = array();
