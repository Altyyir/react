                                ...
                                <table id="example" class="display">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="col-md-3" style="text-align: center;"><strong>Agency</strong></th>
                                            <th class="col-md-3" style="text-align: center;"><strong>Plantilla Position</strong></th>
                                            <th class="col-md-2" style="text-align: center;"><strong>Status of Appointment</strong></th>
                                            <th class="col-md-1" style="text-align: center;"><strong>Date of Appointment</strong></th>
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            $query = "SELECT per.id, per.agency, per.plantilla_position, per.status, per.appointment_start, per.appointment_end, fac.title, fac.first_name, fac.middle_name, fac.last_name FROM employment AS per INNER JOIN faculty_user AS fac ON per.added_by = fac.id WHERE fac.college_id = $college ORDER BY id DESC";
                                       ...
                                       <tr>
                                          ...
                                          <td class="col-md-3" style="text-align: center"><?php echo $row["plantilla_position"]?></td>
                                            ...
                                            ?>
                                            <td class="col-md-1" style="text-align: center;" ><?php echo $appointment_start . " - " . $appointment_end; ?></td>
                                           <!--  <td class="col-md-1">
                                            <div class="d-flex" >
                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="row">
                                                                          ...
                                                                          <div class="col-xl-12">
                                                                            <div class="d-flex justify-content-between flex-wrap">
                                                                              <div class="input-group contacts-search mb-8">
                                                                                <h2 style="margin-left: 27px; margin-top: -3px; font-size: 19px; font-weight: 600; color: #000;">Employment</h2>
                                                                        ...
                                                                        <div class="col-lg-12 mb-3">
                                                                          <label class="form-label ">Agency <span class="text-danger">*</span>
                                                                           ...
                                                                           <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Sector" name="agency"></input>
                                                                        </div>
                                                                        <div class="col-lg-12 mb-3">
                                                                          <label class="form-label ">Plantilla Position <span class="text-danger">*</span>
                                                                          </label>
                                                                           <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Sector" name="plantilla_position"></input>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-lg-6 mb-3">
                                                                          <label class="form-label">Date of Appointment (Start) <span class="text-danger">*</span></label>
                                                                            <input type="date" value="" class="form-control form-control-lg" name="appointment_start" required>
                                                                        </div>
                                                                        <div class="col-lg-6 mb-3">
                                                                          <label class="form-label">(End) <span class="text-danger">*</span></label>
                                                                            <input type="date" value="" class="form-control form-control-lg" name="appointment_end" required>
                                                                        </div>
                                                                        <div class="col-lg-6 mb-3">
                                                                          <label class="form-label">Monthly Salary <span class="text-danger">*</span></label>
                                                                            <input type="number" value="" class="form-control form-control-lg" name="monthly_salary" required>
                                                                        </div>
                                                                    </div> 
                                                                </div>
                                                ...
                                                <a href="tableemployment.php?id=<?php echo $row['id']; ?>" class="btn btn-dark shadow btn-xs sharp me-1"><i class="fas fa-trash"></i></a>
                                            </div> -->
