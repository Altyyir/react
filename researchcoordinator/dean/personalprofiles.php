                      ...
                      <div class="row">
                        <div class="col-lg-3 mb-3">
                          ...
                          <div class="col-lg-3 mb-3">
                           ...
                           <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Civil Status"  name="civilstatus"></input>
                          </div>
                          <div class="col-lg-3 mb-3">
                            <label class="form-label">Gender <span class="text-danger">*</span>
                            </label>
                              <select id="inputState" class="default-select form-control default-select wide" name="title_profile" required>
                          ...
                          <div class="col-lg-3 mb-3">
                            <label class="form-label ">Mobile No. <span class="text-danger">*</span>
                             ...
                             <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Mobile No."  name="mobileno" required></input>
                          </div>
                          ...
                          <div class="col-lg-6 mb-3">
                            <label class="form-label">Region <span class="text-danger">*</span>
                            </label>
                              <select id="inputState" class="default-select form-control default-select wide" name="Region" required>
                          ...
                          <div class="col-lg-6 mb-3">
                            <label class="form-label">Province <span class="text-danger">*</span>
                              ...
                              <select id="inputState" class="default-select form-control default-select wide" name="province" required>
