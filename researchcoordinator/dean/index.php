...
<head>
	...
	<!-- FAVICONS ICON -->
	<link rel="shortcut icon" type="image/jpg" href="images/maamdj.jpg">
					...
					<div class="col-xl-12">
						<div class="row">
							<div class="col-xl-3 col-sm-3">
								<div class="card">
									<div class="card-body d-flex px-4 justify-content-between">
										<div>
											<div class="">
												<h2 class="fs-32 font-w700">3</h2>
												<span class="fs-18 font-w500 d-block">No. of Research Projects</span>
												<span class="fs-15 font-w500 d-block">2023</span>
											</div>
										</div>
										<!-- <div class="bilog">
							...
							<div class="col-xl-3 col-sm-3">
								<div class="card">
									<div class="card-body d-flex px-4 justify-content-between">
										<div>
											<div class="">
												<h2 class="fs-32 font-w700">10200</h2>
							...
							<div class="col-xl-3 col-sm-3">
								<div class="card">
									<div class="card-body d-flex px-4 justify-content-between">
										<div>
											<div class="">
												<h2 class="fs-32 font-w700">5/10</h2>
									...
									<div class="col-xl-12">
										<div class="card">
											<div class="card-header border-0 flex-wrap">
												<h4 class="fs-20 font-w700 mb-2">Research Statistics</h4>
												...
												<div class="d-flex justify-content-between align-items-center flex-wrap">
													<div class="d-flex">
														<div class="d-inline-block position-relative donut-chart-sale mb-3">
															<span class="donut1" data-peity='{ "fill": ["rgba(255,0,0,1.0)", "rgb(250, 128, 114)"],   "innerRadius": 20, "radius": 15}'>5/8</span>
														</div>
														<div class="ms-3">
															<h4 class="fs-24 font-w700 ">0</h4>
															<span class="fs-16 font-w400 d-block">Total Research Projects</span>
														</div>
													</div>
														...
														<div class="d-flex">
															<div class="mt-2">
																<svg width="13" height="13" viewbox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
																	<circle cx="6.5" cy="6.5" r="6.5" fill="#F49398"></circle>
																</svg>
															...
															<div class="ms-3">
																<h4 class="fs-24 font-w700 ">0</h4>
																<span class="fs-16 font-w400 d-block">For Evaluation</span>
															</div>
														</div>
														<div class="d-flex me-4">
															<div class="mt-2">
																<svg width="13" height="13" viewbox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
																	<circle cx="6.5" cy="6.5" r="6.5" fill="#ee525a"></circle>
																</svg>
															</div>
														</div>
															<div class="ms-3">
																<h4 class="fs-24 font-w700 ">0</h4>
																<span class="fs-16 font-w400 d-block">Approve with notice to proceed</span>
															</div>
															<div class="d-flex me-4">
															<div class="mt-2">
																<svg width="13" height="13" viewbox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
																	<circle cx="6.5" cy="6.5" r="6.5" fill="#e79f31"></circle>
																</svg>
															</div>
														</div>
															<div class="ms-3">
																<h4 class="fs-24 font-w700 ">0</h4>
																<span class="fs-16 font-w400 d-block">Ongoing</span>
															</div>
															<div class="d-flex me-4">
															<div class="mt-2">
																<svg width="13" height="13" viewbox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
																	<circle cx="6.5" cy="6.5" r="6.5" fill="#DB7093"></circle>
																</svg>
															</div>
														</div>
															<div class="ms-3">
																<h4 class="fs-24 font-w700 ">0</h4>
																<span class="fs-16 font-w400 d-block">Completed</span>
															</div>
														</div>
													</div>
												</div>
							...
							<div class="col-xl-4 col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title" style="font-size: 14px;">Research Projects</h4>
                                        <h1 style="font-size:10px">By number of Research R&D per Colleges</h1>
                                    </div>
                                    <div class="card-body">
							 ...
							 <div class="col-xl-4 col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title" style="font-size: 14px;">Publication</h4> 
                                        <div class="row">
                                          	<h1 style="font-size:10px">By number of Publication per Colleges</h1></div>
                            ...
                            <div class="col-xl-4 col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title" style="font-size: 14px;">R&D Expenditures</h4> 
												...
												<div class="row">
													<div class="col-xl-6 col-sm-6">
														<div class=" owl-carousel card-slider">
															<div class="items">
																<h4 class="fs-20 font-w700 mb-4">ReAcT</h4>
																<span class="fs-14 font-w400">Jhorely C. Gabriel <br> Erlyn S. Andrin <br> Cristie O. Andino</span>
															</div>	
															<div class="items">
													...
													<div class="col-xl-6 redial col-sm-6">
														<div id="redial"></div>
														<span class="text-center d-block fs-18 font-w600">On Progress</span>	
													</div>
												</div>
											</div>
										</div>
