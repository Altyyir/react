...
if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<p style="font-size: 14px;">' . $row['title'] . '</p>';
        // ... Add the rest of your card HTML here
        echo '</div>';
        
        // Wrap the image with an anchor tag for downloading
        echo '<a href="../certificate_upload/' . $row['image_path'] . '" download>';
        echo '<img class="card-img-bottom img-fluid" src="../' . $row['image_path'] . '" alt="Card image cap" style="padding: 5px 5px 5px 5px; height: 140px;">'; // Set the height to 100px
        echo '</a>';
        
        // Card Footer with fixed height and overflow: hidden
        echo '<div class="card-footer" style="height: 50px; overflow: hidden; padding: 10px 10px 10px 10px">';
        
        // Open the link in a new tab using target="_blank"
        echo '<a style="color: #1f89e5" href="'. $row['link']. '" target="_blank">'. $row['link']. '</a>';
    ...
    echo '<label style="font-size:20px; text-align: center"> No certificates found. </label>';
}
?>
