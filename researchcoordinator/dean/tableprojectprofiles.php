        ...
        <div class="row">
          <div class="col-xl-12">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
              ...
              <!-- <div class="mb-4">
                <a href="projectprofiles.php" type="button" class="btn btn-primary btn-rounded fs-16"><i class="fas fa-plus me-3 scale4" style="color: #fff;"></i>Add More Conference Attended</a>
              </div> -->
              <div class="col-xl-12">
                                ...
                                <div class="table-responsive">
                                    <table id="example" class="tableResearch">
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                                <td><strong>MET: A Web-Based Monitoring and Evaluation of Target Extension Program, Activities And Projects (PAPs), Batangas State University, January 08, 2018 - Completed</strong></td>
