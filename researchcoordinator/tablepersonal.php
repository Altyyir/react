                                ...
                                <table id="example" class="display">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="col-md-4"><strong>Email</strong></th>
                                            <th class="col-md-2"><strong>Mobile No.</strong></th>
                                            <th class="col-md-2" style="padding-left: 80px"><strong>Action</strong></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php 
                                            $college = $_SESSION['college'];
                                            $query = "SELECT pp.* FROM personal_profile as pp INNER JOIN faculty_user as fu ON pp.added_by = fu.id WHERE fu.college_id = $college ORDER BY id DESC";
                                        ...
                                        <tr>
                                           ...
                                           <td class="col-md-4"><?php echo $row["title_profile"].' '.$row["firstname"] . ' ' . $row["middlename"] . ' ' . $row["lastname"]; ?><div class="rounded-lg me-2" width="350px" alt="" style="text-align: left;"></div></td>
                                          <td class="col-md-4" ><?php echo $row["emailprimary"]?></td>
                                            <td class="col-md-2"><?php echo $row["mobileno"]?></td>
                                            <td class="col-md-2" style="padding-left: 91px">
