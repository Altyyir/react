 ...
 $(function(){
  ...
  $(function(){
    ...
    $(function(){
        ...
        var $specializationsForm = $("#specializations");

        $specializationsForm.validate({
          rules:{
            specialization:{
              required:true
            },
          ...
          messages:{
            ...
            primary_field:{
              required:'Primary Field must be required.'
            },
          }
        })
  ...
  $(function(){
        ...
        $conferencesForm.validate({
          ...
          messages:{
            ...
            organizer:{
              required:'Sponsor must be required.'
            },
            venue:{
...
$(function(){
        ...
        var $seminar_trainingForm = $("#seminar_training");

        $seminar_trainingForm.validate({
          rules:{
            title_seminar:{
              required:true
            },
          ...
          messages:{
            ...
            conference_seminar:{
              required:'Level of Seminar/Training must be required.' 
            },
            from_seminar:{
              required:'Date must be required.'
            },
...
$(function(){
        ...
        $ctcForm.validate({
          ...
          messages:{
            ...
            conference_ctc:{
              required:'Level of Capability Training must be required.'
            },
            organizer_ctc:{
              required:'Organizer must be required.' 
            },
