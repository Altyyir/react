(function($) {
 ...
 var dlabSparkLine = function(){
  ...
  if (jQuery('#barChart_3').length > 0) {
    ...
    barChart_3gradientStroke.addColorStop(0, "#a19c9c");
    barChart_3gradientStroke.addColorStop(1, "#a19c9c");
    ...
    new Chart(barChart_3, {
      ...
      data: {
        ...
        labels: ['CICS', 'CABEIHM', 'CAS', 'CET', 'CONAHS'],
        datasets: [
          {
            label: "My First dataset",
            data: [10000, 20000, 30000, 40000, 50000, 60000, 70000, 80000, 90000, 100000, 200000, 300000, 400000, 500000],
	...
	// 						label: "My First dataset",
	// 						data: [25, 20, 60, 41, 66],
	// 						borderColor: 'rgba(248,62,62, 1)',
	// 						borderWidth: "2",
	// 						backgroundColor: 'transparent',  
	// 						pointBackgroundColor: 'rgba(248,62,62, 1)'
	// 					}
	// 				]
	// 			},
	// 			options: {
