                    ...
                    <table id="example" class="display">
                      <thead>
                        <tr>
                          ...
                          <th class="col-md-3" style="text-align: center;"><strong>Title of Project</strong></th>
                          <th class="col-md-2" style="text-align: center;"><strong>Funding Institution</strong></th>
                          <th class="col-md-1" style="text-align: center;"><strong>Inclusive Date</strong></th>
                          <th class="col-md-2" style="text-align: center;"><strong>Status</strong></th>
                          <th class="col-md-2" style="text-align: center;"><strong>Evidence</strong></th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php
                        $college = $_SESSION['college'];
                        $query = "SELECT per.id, per.titleproject, per.typefundinginstitution, per.from_project, per.to_project, per.status, per.file, fac.title, fac.first_name, fac.middle_name, fac.last_name FROM project_profile AS per INNER JOIN faculty_user AS fac ON per.added_by = fac.id WHERE fac.college_id = $college ORDER BY id DESC";
                        ...
                        ?>
                          <tr>
                            ...
                            <td class="col-md-3" style="text-align: center;"><?php echo $row["titleproject"] ?></td>
                            ...
                            <td class="col-md-1" style="text-align: center;"><?php echo $from_project . " - " . $to_project; ?></td>
                            <td class="col-md-2" style="text-align: center;"><?php echo $row["status"] ?></td>
                            <td class="col-md-2" style="text-align: center;">
                              <a class="btn btn-dark shadow btn-xs sharp me-1" href="../projectprofiles_upload/<?= $row['file'] ?>" target="_blank" title="View"><i class="fas fa-eye"></i></a>
                            </td>
                            </td>
                          </tr>
                        <?php
