                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="col-md-3">
                          <div class="rounded-lg me-2" width="350px" alt="" style="text-align: left;"></div><?php echo $row["agency"] ?>
                        </td>
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-lg-6 mb-3">
                                            ...
                                            <select id="inputState" class="default-select form-control default-select wide" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;" name="status" required>
                                              ...
                                              <option <?php if ($row['status'] == 'Permanent') {
                                                        echo "selected";
                                                      } ?>>Permanent</option>
                                              <option <?php if ($row['status'] == 'Temporary') {
                                                        echo "selected";
                                                      } ?>>Temporary</option>
                                              <option <?php if ($row['status'] == 'Contratual') {
                                                        echo "selected";
                                                      } ?>>Contratual</option>
                                              <option <?php if ($row['status'] == 'Casual') {
                                                        echo "selected";
                                                      } ?>>Casual</option>
                                              <option <?php if ($row['status'] == 'Emergency') {
                                                        echo "selected";
                                                      } ?>>Emergency</option>
