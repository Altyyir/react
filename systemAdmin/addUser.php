                                ...
                                <div class="basic-form">
                                    <form method="post" action="addUser.php">
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-3">
                                                <label class="form-label">Middle Name <span class="text-danger">*</span>
                                                </label>
                                                <input type="text" class="form-control form-control-lg" placeholder="Middle Name">
                                            </div>
                                            <div class="mb-3 col-md-3">
                                        ...
                                        <div class="row">
                                            <div class="mb-3 col-md-3">
                                                ...
                                                <select id="inputState" class="default-select form-control wide form-control-lg" name="gender"required>
                                        ...
                                        <div class="row">
                                            <div class="mb-3 col-md-12 input-container">
                                                ...
                                                <input type="password" id="password" class="form-control form-control-lg password-input" placeholder="Password">
