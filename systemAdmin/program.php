...
<head>
	...
	<!-- FAVICONS ICON -->
	<link rel="shortcut icon" type="image/jpg" href="images/user.jpg">
    ...
    ***********************************-->
    <div id="main-wrapper">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                        	<div class="row">
                                    			...
                                    			<select class="default-select form-control wide form-control-lg" name="Campus" required>
                                        	...
                                        	<div class="row" style="margin-top: 14px;">
                                            	<div class="col-md-3">
                                                	<label class="form-label">Abbreviation <span class="text-danger">*</span></label>
                                               		...
                                               		<input type="text" name="address" class="form-control form-control-lg" placeholder="Abbreviation" required>
                                            </div>
                                        	<div class="row" style="margin-top: 14px;">
                                            	<div class="col-md-3">
                                                	<label class="form-label">Program <span class="text-danger">*</span></label>
                                               	</div>
                                               		<input type="text" name="address" class="form-control form-control-lg" placeholder="Program" required>
                                            </div>
                                        </div>
                                    ...
                                    <table id="example" class="tableResearch">
                                        ...
                                        <tbody>
											<tr>
                                                ...
                                                <td>CEAFA</td>
                                                <td>Bachelor of Fine and Design major in Visual Communication</td>
                                                <td>BFAD</td>
                                                <td>
													<div class="d-flex">
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by REACT 2021</p>
