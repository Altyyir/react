		...
		<div class="dlabnav">
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a href="addUser.php" class="" aria-expanded="false">
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="d-flex justify-content-between align-items-center flex-wrap">
							...
							<div class="mb-4">
								<button type="button" class="btn btn-primary btn-rounded fs-16" data-bs-toggle="modal" data-bs-target="#modalGrid"><i class="fas fa-plus me-3 scale4" style="color: #fff;"></i>Add User</a></button>
							</div>
                                        ...
                                        <div class="modal-body">
                                        	<form method="post" action="index.php">
                                                ...
                                                <div class="row" style="margin-top: 14px;">
                                                    ...
                                                    <input type="email" name="useremail" class="form-control" placeholder="email@example.com">
                                                </div>
                                                <div class="row" style="margin-top: 14px;">
                                    ...
                                    <table id="example" class="tableResearch">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class='fullnameheader'><strong>Fullname</strong></th>
                                                <th class="emailheader"><strong>Email</strong></th>
                                                <th class="collegeheader" style="text-align: center;"><strong>College</strong></th>
                                        ...
                                        <tbody>
											<tr>
                                                ...
                                                <td><span class="badge light badge-danger">Deactivate</span></td>
                                                <td>
													<div class="d-flex">
