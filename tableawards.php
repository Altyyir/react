                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="col-md-3">
                          <div class="rounded-lg me-2" width="350px" alt="" style="text-align: left;"></div><?php echo $row["award"] ?>
                        </td>
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-lg-6 mb-3">
                                            ...
                                            <select id="inputState" class="default-select form-control default-select wide" name="category" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;" required>
                                              ...
                                              <option <?php if ($row['category'] == 'Local - In-house') {
                                                        echo "selected";
                                                      } ?>>Local - In-house</option>
                                              <option <?php if ($row['category'] == 'Local – Regional') {
                                                        echo "selected";
                                                      } ?>>Local – Regional</option>
                                              <option <?php if ($row['category'] == 'Local – National') {
                                                        echo "selected";
                                                      } ?>>Local – National</option>
                                              <option <?php if ($row['category'] == 'International') {
                                                        echo "selected";
                                                      } ?>>International</option>
                                              <option <?php if ($row['category'] == 'Others') {
                                                        echo "selected";
                                                      } ?>>Others</option>
                                            </select>
                                          </div>
