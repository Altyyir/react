...
<!--                                <input type="text" class="form-control" placeholder="Search here...">
                                ...
                                <div class="mb-4">
                                    <a href="awards.php" type="button" class="btn btn-primary btn-rounded fs-16"><i class="fas fa-plus me-3 scale4" style="color: #fff;"></i>Add R&D Awards</a>
                                  </div>
                            </div>
                        </div>
                    </div>              
                                ...
                                <table id="example5" class="display">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="col-md-3"><strong>Title of R&D Award</strong></th>
                                            <th class="col-md-2" style="text-align: center;"><strong>Category</strong></th>
                                            <th class="col-md-3" style="text-align: center;"><strong>Granting Institution</strong></th>
                                            <th class="col-md-2" style="text-align: center;"><strong>Year Granted</strong></th>
                                            <th class="col-md-1"><strong>Action</strong></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php 
                                            $query = "SELECT * FROM award WHERE added_by = {$user_id} ORDER BY `id` DESC";
                                        ...
                                        <tr>
                                           ...
                                           <td class="col-md-3"><div class="rounded-lg me-2" width="350px" alt="" style="text-align: left;"></div><?php echo $row["award"]?></td>
                                          <td class="col-md-2" style="text-align: center;"><?php echo $row["category"]?></td>
                                            <td class="col-md-3" style="text-align: center;"><?php echo $row["granting_institution"]?></td>

                                            <?php
                                            $year_granted = strtotime($row['year_granted']);
                                            $year_granted_formatted = date("M d, Y", $year_granted);
                                            ?>

                                            <td class="col-md-2" style="text-align: center;"><?php echo $year_granted_formatted?></td>
                                            <td class="col-md-1">
                                            <div class="d-flex" >
                                                <div class="d-flex">
                                                    ...
                                                    <div id="edit-modal-<?=$row['id']?>" class="modal fade bd-example-modal-lg">
                                                        <div class="modal-dialog modal-lg ">
                                                            <div class="modal-content">
                                                                <form method="post" action="edit.award.php">
                                                                <input type="hidden" name="id" value="<?=$row['id']?>">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" style="font-size: 23px">Update R&D Award</h5>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                            <div class="col-lg-10 mb-3">
                                                                              <label class="form-label ">Title of R&D Award <span class="text-danger">*</span>
                                                                              </label>
                                                                               <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Title of R&D Award" name="award" value="<?=$row['award']?>"></input>
                                                                            </div>
                                                                            <div class="col-lg-2 mb-3">
                                                                              <label class="form-label ">Rank <span class="text-danger">*</span>
                                                                              </label>
                                                                               <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Rank" name="rank" value="<?=$row['rank']?>"></input>
                                                                            </div>
                                                                            <div class="col-lg-6 mb-3">
                                                                              <label class="form-label ">Category <span class="text-danger">*</span>
                                                                              </label>
                                                                               <select id="inputState" class="default-select form-control default-select wide" name="category" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;" required>
                                                                                  <option>Choose Category</option>
                                                                                  <option <?php if($row['category'] == 'Local - In-house'){echo "selected";}?>>Local - In-house</option>
                                                                                  <option <?php if($row['category'] == 'Local – Regional'){echo "selected";}?>>Local – Regional</option>
                                                                                  <option <?php if($row['category'] == 'Local – National'){echo "selected";}?>>Local – National</option>
                                                                                  <option <?php if($row['category'] == 'International'){echo "selected";}?>>International</option>
                                                                                  <option <?php if($row['category'] == 'Others'){echo "selected";}?>>Others</option>
                                                                                </select>
                                                                            </div>
                                                                            <div class="col-lg-6 mb-3">
                                                                              <label class="form-label ">Year Granted <span class="text-danger">*</span>
                                                                              </label>
                                                                                <input type="date" class="form-control form-control-lg" name="year_granted" value="<?=$row['year_granted']?>" required>
                                                                            </div>
                                                                            <div class="col-lg-12 mb-3">
                                                                              <label class="form-label ">Granting Institution <span class="text-danger">*</span>
                                                                              </label>
                                                                               <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Granting Institution" name="granting_institution" value="<?=$row['granting_institution']?>"></input>
                                                                            </div>
                                                                    </div> 
                                                                </div>
        ...
        function deleteRecord(e) {
            ...
            .then((result) => {
              if(result) {
                ...
                deleteRecord.open("GET", "delete.record.php?table=award&id="+e); // yung pangalan lang ng table ang papalitan
                deleteRecord.send();
