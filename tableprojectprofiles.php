                                ...
                                <table id="example5" class="display">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                           ...
                                           <td class="col-md-3"><div class="rounded-lg me-2" width="350px" alt="" style="text-align: left;"></div><?php echo $row["titleproject"]?></td>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-6 mb-3">
                                                                             ...
                                                                             <select id="inputState" class="form-control form-control-lg" name="typeproject" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;">
                                                                              ...
                                                                              <option <?php if($row['typeproject'] == 'Basic Research'){echo "selected";}?>>Basic Research</option>
                                                                              <option <?php if($row['typeproject'] == 'Applied Research'){echo "selected";}?>>Applied Research</option>
                                                                              <option <?php if($row['typeproject'] == 'Others'){echo "selected";}?>>Others</option>
                                                                            </select>
                                                                        </div>
                                                                        <div class="col-lg-6 mb-3">
                                                                       ...
                                                                       <div class="col-lg-6 mb-3">
                                                                            <label class="form-label">Type of Funding Institution <span class="text-danger">*</span>
                                                                               ...
                                                                               <select id="inputState" class="default-select form-control default-select wide" name="typefundinginstitution" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;">
                                                                                ...
                                                                                <option <?php if($row['typefundinginstitution'] == 'Local'){echo "selected";}?>>Local</option>
                                                                                <option <?php if($row['typefundinginstitution'] == 'National'){echo "selected";}?>>National</option>
                                                                                <option <?php if($row['typefundinginstitution'] == 'International'){echo "selected";}?>>International</option>
                                                                                 <option <?php if($row['typefundinginstitution'] == 'Goverment'){echo "selected";}?>>Goverment</option>
                                                                                 <option <?php if($row['typefundinginstitution'] == 'Others'){echo "selected";}?>>Others</option>
                                                                              </select>
                                                                        </div>
                                                                        <div class="col-lg-6 mb-3">
                                                                        ...
                                                                        <div class="col-lg-6 mb-3">
                                                                            <label class="form-label">Position in the Project <span class="text-danger">*</span>
                                                                             ...
                                                                             <select id="inputState" class="default-select form-control default-select wide" name="positionproject" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;" required>
                                                                                ...
                                                                                <option <?php if($row['positionproject'] == 'Co-Program Leader'){echo "selected";}?>>Co-Program Leader</option>
                                                                                <option <?php if($row['positionproject'] == 'Co-Project Leader'){echo "selected";}?>>Co-Project Leader</option>
                                                                                <option <?php if($row['positionproject'] == 'Program Coordinator'){echo "selected";}?>>Program Coordinator</option>
                                                                                <option <?php if($row['positionproject'] == 'Program Leader'){echo "selected";}?>>Program Leader</option>
                                                                                <option <?php if($row['positionproject'] == 'Project Leader'){echo "selected";}?>>Project Leader</option>
                                                                                <option <?php if($row['positionproject'] == 'Research & Development Staff'){echo "selected";}?>>Research & Development Staff</option>
                                                                                <option <?php if($row['positionproject'] == 'Others'){echo "selected";}?>>Others</option>
                                                                              </select>                          
                                                                          </div>
                                                                    </div>  
                                                                    <div class="row">
                                                                        <div class="col-lg-6 mb-3">
                                                                            <label class="form-label">Status <span class="text-danger">*</span>
                                                                               ...
                                                                               <select id="inputState" class="default-select form-control default-select wide" name="status" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;">
                                                                                ...
                                                                                <option <?php if($row['status'] == 'Completed with Terminal Report'){echo "selected";}?>>Completed with Terminal Report</option>
                                                                                <option <?php if($row['status'] == 'Completed w/o Terminal Report'){echo "selected";}?>>Completed w/o Terminal Report</option>
                                                                                <option <?php if($row['status'] == 'Deferred (approval)'){echo "selected";}?>>Deferred (approval)</option>
                                                                                <option <?php if($row['status'] == 'Deferred (impl’n)'){echo "selected";}?>>Deferred (impl’n)</option>
                                                                                <option <?php if($row['status'] == 'Disapproved'){echo "selected";}?>>Disapproved</option>
                                                                                <option <?php if($row['status'] == 'Extended New'){echo "selected";}?>>Extended New</option>
                                                                                <option <?php if($row['status'] == 'Ongoing'){echo "selected";}?>>Ongoing</option>
                                                                                <option <?php if($row['status'] == 'Proposed Reactivated'){echo "selected";}?>>Proposed Reactivated</option>
                                                                                <option <?php if($row['status'] == 'Recommended Rejected'){echo "selected";}?>>Recommended Rejected</option>
                                                                                <option <?php if($row['status'] == 'Suspended Terminated'){echo "selected";}?>>Suspended Terminated</option>
                                                                                <option <?php if($row['status'] == 'Terminated with Terminal Report'){echo "selected";}?>>Terminated with Terminal Report</option>
                                                                        ...
                                                                        <div class="col-lg-6 mb-3">
                                                                            <label class="form-label">Sector <span class="text-danger">*</span>
                                                                               ...
                                                                               <select class="default-select form-control default-select wide" name="sector" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;">
                                                                                ...
                                                                                <option <?php if($row['sector'] == 'Agricultural Resources Management'){echo "selected";}?>>Agricultural Resources Management</option>
                                                                                <option <?php if($row['sector'] == 'Crops'){echo "selected";}?>>Crops</option>
                                                                                <option <?php if($row['sector'] == 'Forestry and Env’t'){echo "selected";}?>>Forestry and Env’t</option>
                                                                                <option <?php if($row['sector'] == 'Livestock'){echo "selected";}?>>Livestock</option>
                                                                                <option <?php if($row['sector'] == 'Sociol-economics'){echo "selected";}?>>Sociol-economics</option>
                                                                                <option <?php if($row['sector'] == 'Others'){echo "selected";}?>>Others</option>
                                                                              </select>
                                                                          </div>
                                                                        <div class="col-lg-6 mb-3">
