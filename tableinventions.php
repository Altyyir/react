                                      ...
                                      <div class="row">
                                        <div class="col-lg-6 mb-3">
                                          ...
                                          <select id="inputState" class="form-control form-control-lg" name="right_type" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;">
                                            ...
                                            <option <?php if ($row['right_type'] == 'Patent') {
                                                      echo "selected";
                                                    } ?>>Patent</option>
                                            <option <?php if ($row['right_type'] == 'Utility Model') {
                                                      echo "selected";
                                                    } ?>>Utility Model</option>
                                            <option <?php if ($row['right_type'] == 'Copyright') {
                                                      echo "selected";
                                                    } ?>>Copyright</option>
                                          </select>
                                        </div>
                                        ...
                                        <div class="col-lg-6 mb-3">
                                          ...
                                          <select id="inputState" class="default-select form-control default-select wide" name="country" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;" required>
                                            ...
                                            <option<?php if ($row['country'] == 'Afghanistan') {
                                                      echo "selected";
                                                    } ?>>Afghanistan</option>
                                              <option <?php if ($row['country'] == 'Albania') {
                                                        echo "selected";
                                                      } ?>>Albania</option>
                                              <option <?php if ($row['country'] == 'Algeria') {
                                                        echo "selected";
                                                      } ?>>Algeria</option>
                                              <option <?php if ($row['country'] == 'Andorra') {
                                                        echo "selected";
                                                      } ?>>Andorra</option>
                                              <option <?php if ($row['country'] == 'Angola') {
                                                        echo "selected";
                                                      } ?>>Angola</option>
                                              <option <?php if ($row['country'] == 'Antigua and Barbuda') {
                                                        echo "selected";
                                                      } ?>>Antigua and Barbuda</option>
                                              <option <?php if ($row['country'] == 'Argentina') {
                                                        echo "selected";
                                                      } ?>>Argentina</option>
                                              <option <?php if ($row['country'] == 'Armenia') {
                                                        echo "selected";
                                                      } ?>>Armenia</option>
                                              <option <?php if ($row['country'] == 'Australia') {
                                                        echo "selected";
                                                      } ?>>Australia</option>
                                              <option <?php if ($row['country'] == 'Austria') {
                                                        echo "selected";
                                                      } ?>>Austria</option>
                                              <option <?php if ($row['country'] == 'Azerbaijan') {
                                                        echo "selected";
                                                      } ?>>Azerbaijan</option>
                                              <option <?php if ($row['country'] == 'Bahamas') {
                                                        echo "selected";
                                                      } ?>>Bahamas</option>
                                              <option <?php if ($row['country'] == 'Bahrain') {
                                                        echo "selected";
                                                      } ?>>Bahrain</option>
                                              <option <?php if ($row['country'] == 'Bangladesh') {
                                                        echo "selected";
                                                      } ?>>Bangladesh</option>
                                              <option <?php if ($row['country'] == 'Barbados') {
                                                        echo "selected";
                                                      } ?>>Barbados</option>
                                              <option <?php if ($row['country'] == 'Belarus') {
                                                        echo "selected";
                                                      } ?>>Belarus</option>
                                              <option <?php if ($row['country'] == 'Belgium') {
                                                        echo "selected";
                                                      } ?>>Belgium</option>
                                              <option <?php if ($row['country'] == 'Belize') {
                                                        echo "selected";
                                                      } ?>>Belize</option>
                                              <option <?php if ($row['country'] == 'Benin') {
                                                        echo "selected";
                                                      } ?>>Benin</option>
                                              <option <?php if ($row['country'] == 'Bhutan') {
                                                        echo "selected";
                                                      } ?>>Bhutan</option>
                                              <option <?php if ($row['country'] == 'Bolivia') {
                                                        echo "selected";
                                                      } ?>>Bolivia</option>
                                              <option> <?php if ($row['country'] == 'Bosnia') {
                                                          echo "selected";
                                                        } ?>Bosnia and Herzegovina</option>
                                              <option <?php if ($row['country'] == 'Botswana') {
                                                        echo "selected";
                                                      } ?>>Botswana</option>
                                              <option <?php if ($row['country'] == 'Brazil') {
                                                        echo "selected";
                                                      } ?>>Brazil</option>
                                              <option <?php if ($row['country'] == 'Brunei') {
                                                        echo "selected";
                                                      } ?>>Brunei</option>
                                              <option <?php if ($row['country'] == 'Bulgaria') {
                                                        echo "selected";
                                                      } ?>>Bulgaria</option>
                                              <option <?php if ($row['country'] == 'Burkina Faso') {
                                                        echo "selected";
                                                      } ?>>Burkina Faso</option>
                                              <option <?php if ($row['country'] == 'Burundi') {
                                                        echo "selected";
                                                      } ?>>Burundi</option>
                                              <option <?php if ($row['country'] == 'Cambodia') {
                                                        echo "selected";
                                                      } ?>>Cambodia</option>
                                              <option <?php if ($row['country'] == 'Cameroon') {
                                                        echo "selected";
                                                      } ?>>Cameroon</option>
                                              <option <?php if ($row['country'] == 'Canada') {
                                                        echo "selected";
                                                      } ?>>Canada</option>
                                              <option <?php if ($row['country'] == 'Cape Verde') {
                                                        echo "selected";
                                                      } ?>>Cape Verde</option>
                                              <option <?php if ($row['country'] == 'Central African Republic') {
                                                        echo "selected";
                                                      } ?>>Central African Republic</option>
                                              <option <?php if ($row['country'] == 'Chad') {
                                                        echo "selected";
                                                      } ?>>Chad</option>
                                              <option <?php if ($row['country'] == 'Chile') {
                                                        echo "selected";
                                                      } ?>>Chile</option>
                                              <option <?php if ($row['country'] == 'China') {
                                                        echo "selected";
                                                      } ?>>China</option>
                                              <option <?php if ($row['country'] == 'Colombia') {
                                                        echo "selected";
                                                      } ?>>Colombia</option>
                                              <option <?php if ($row['country'] == 'Comoros') {
                                                        echo "selected";
                                                      } ?>>Comoros</option>
                                              <option <?php if ($row['country'] == 'Congo') {
                                                        echo "selected";
                                                      } ?>>Congo</option>
                                              <option <?php if ($row['country'] == 'Costa Rica') {
                                                        echo "selected";
                                                      } ?>>Costa Rica</option>
                                              <option <?php if ($row['country'] == 'Croatia') {
                                                        echo "selected";
                                                      } ?>>Croatia</option>
                                              <option <?php if ($row['country'] == 'Cuba') {
                                                        echo "selected";
                                                      } ?>>Cuba</option>
                                              <option <?php if ($row['country'] == 'Cyprus') {
                                                        echo "selected";
                                                      } ?>>Cyprus</option>
                                              <option <?php if ($row['country'] == 'Czech Republic') {
                                                        echo "selected";
                                                      } ?>>Czech Republic</option>
                                              <option <?php if ($row['country'] == 'Democratic Republic of the Congo') {
                                                        echo "selected";
                                                      } ?>>Democratic Republic of the Congo</option>
                                              <option> <?php if ($row['country'] == 'Denmark') {
                                                          echo "selected";
                                                        } ?>Denmark</option>
                                              <option <?php if ($row['country'] == 'Djibouti') {
                                                        echo "selected";
                                                      } ?>>Djibouti</option>
                                              <option <?php if ($row['country'] == 'Dominica') {
                                                        echo "selected";
                                                      } ?>>Dominica</option>
                                              <option <?php if ($row['country'] == 'Dominican Republic') {
                                                        echo "selected";
                                                      } ?>>Dominican Republic</option>
                                              <option <?php if ($row['country'] == 'East Timor') {
                                                        echo "selected";
                                                      } ?>>East Timor</option>
                                              <option <?php if ($row['country'] == 'Ecuador') {
                                                        echo "selected";
                                                      } ?>>Ecuador</option>
                                              <option <?php if ($row['country'] == 'Egypt') {
                                                        echo "selected";
                                                      } ?>>Egypt</option>
                                              <option <?php if ($row['country'] == 'El Salvador') {
                                                        echo "selected";
                                                      } ?>>El Salvador</option>
                                              <option <?php if ($row['country'] == 'Equatorial Guinea') {
                                                        echo "selected";
                                                      } ?>>Equatorial Guinea</option>
                                              <option <?php if ($row['country'] == 'Eritrea') {
                                                        echo "selected";
                                                      } ?>>Eritrea</option>
                                              <option <?php if ($row['country'] == 'Estonia') {
                                                        echo "selected";
                                                      } ?>>Estonia</option>
                                              <option <?php if ($row['country'] == 'Eswatini') {
                                                        echo "selected";
                                                      } ?>>Eswatini</option>
                                              <option <?php if ($row['country'] == 'Ethiopia') {
                                                        echo "selected";
                                                      } ?>>Ethiopia</option>
                                              <option <?php if ($row['country'] == 'Fiji') {
                                                        echo "selected";
                                                      } ?>>Fiji</option>
                                              <option <?php if ($row['country'] == 'Finland') {
                                                        echo "selected";
                                                      } ?>>Finland</option>
                                              <option <?php if ($row['country'] == 'France') {
                                                        echo "selected";
                                                      } ?>>France</option>
                                              <option <?php if ($row['country'] == 'Gabon') {
                                                        echo "selected";
                                                      } ?>>Gabon</option>
                                              <option <?php if ($row['country'] == 'Gambia') {
                                                        echo "selected";
                                                      } ?>>Gambia</option>
                                              <option <?php if ($row['country'] == 'Georgia') {
                                                        echo "selected";
                                                      } ?>>Georgia</option>
                                              <option <?php if ($row['country'] == 'Germany') {
                                                        echo "selected";
                                                      } ?>>Germany</option>
                                              <option <?php if ($row['country'] == 'Ghana') {
                                                        echo "selected";
                                                      } ?>>Ghana</option>
                                              <option <?php if ($row['country'] == 'Greece') {
                                                        echo "selected";
                                                      } ?>>Greece</option>
                                              <option <?php if ($row['country'] == 'Grenada') {
                                                        echo "selected";
                                                      } ?>>Grenada</option>
                                              <option <?php if ($row['country'] == 'Guatemala') {
                                                        echo "selected";
                                                      } ?>>Guatemala</option>
                                              <option <?php if ($row['country'] == 'Guinea') {
                                                        echo "selected";
                                                      } ?>>Guinea</option>
                                              <option <?php if ($row['country'] == 'Guinea-Bissau') {
                                                        echo "selected";
                                                      } ?>>Guinea-Bissau</option>
                                              <option <?php if ($row['country'] == 'Guyana') {
                                                        echo "selected";
                                                      } ?>>Guyana</option>
                                              <option <?php if ($row['country'] == 'Haiti') {
                                                        echo "selected";
                                                      } ?>>Haiti</option>
                                              <option <?php if ($row['country'] == 'Honduras') {
                                                        echo "selected";
                                                      } ?>>Honduras</option>
                                              <option <?php if ($row['country'] == 'Hungary') {
                                                        echo "selected";
                                                      } ?>>Hungary</option>
                                              <option <?php if ($row['country'] == 'Iceland') {
                                                        echo "selected";
                                                      } ?>>Iceland</option>
                                              <option <?php if ($row['country'] == 'India') {
                                                        echo "selected";
                                                      } ?>>India</option>
                                              <option <?php if ($row['country'] == 'Indonesia') {
                                                        echo "selected";
                                                      } ?>>Indonesia</option>
                                              <option <?php if ($row['country'] == 'Iran') {
                                                        echo "selected";
                                                      } ?>>Iran</option>
                                              <option <?php if ($row['country'] == 'Iraq') {
                                                        echo "selected";
                                                      } ?>>Iraq</option>
                                              <option <?php if ($row['country'] == 'Ireland') {
                                                        echo "selected";
                                                      } ?>>Ireland</option>
                                              <option <?php if ($row['country'] == 'Israel') {
                                                        echo "selected";
                                                      } ?>>Israel</option>
                                              <option <?php if ($row['country'] == 'Italy') {
                                                        echo "selected";
                                                      } ?>>Italy</option>
                                              <option <?php if ($row['country'] == 'Ivory Coast') {
                                                        echo "selected";
                                                      } ?>>Ivory Coast</option>
                                              <option <?php if ($row['country'] == 'Jamaica') {
                                                        echo "selected";
                                                      } ?>>Jamaica</option>
                                              <option <?php if ($row['country'] == 'Japan') {
                                                        echo "selected";
                                                      } ?>>Japan</option>
                                              <option <?php if ($row['country'] == 'Jordan') {
                                                        echo "selected";
                                                      } ?>>Jordan</option>
                                              <option <?php if ($row['country'] == 'Kazakhstan') {
                                                        echo "selected";
                                                      } ?>>Kazakhstan</option>
                                              <option <?php if ($row['country'] == 'Kenya') {
                                                        echo "selected";
                                                      } ?>>Kenya</option>
                                              <option <?php if ($row['country'] == 'Kiribati') {
                                                        echo "selected";
                                                      } ?>>Kiribati</option>
                                              <option <?php if ($row['country'] == 'Kuwait') {
                                                        echo "selected";
                                                      } ?>>Kuwait</option>
                                              <option <?php if ($row['country'] == 'Kyrgyzstan') {
                                                        echo "selected";
                                                      } ?>>Kyrgyzstan</option>
                                              <option <?php if ($row['country'] == 'Laos') {
                                                        echo "selected";
                                                      } ?>>Laos</option>
                                              <option <?php if ($row['country'] == 'Latvia') {
                                                        echo "selected";
                                                      } ?>>Latvia</option>
                                              <option <?php if ($row['country'] == 'Lebanon') {
                                                        echo "selected";
                                                      } ?>>Lebanon</option>
                                              <option <?php if ($row['country'] == 'Lesotho') {
                                                        echo "selected";
                                                      } ?>>Lesotho</option>
                                              <option <?php if ($row['country'] == 'Liberia') {
                                                        echo "selected";
                                                      } ?>>Liberia</option>
                                              <option <?php if ($row['country'] == 'Libya') {
                                                        echo "selected";
                                                      } ?>>Libya</option>
                                              <option <?php if ($row['country'] == 'Liechtenstein') {
                                                        echo "selected";
                                                      } ?>>Liechtenstein</option>
                                              <option <?php if ($row['country'] == 'Lithuania') {
                                                        echo "selected";
                                                      } ?>>Lithuania</option>
                                              <option <?php if ($row['country'] == 'Luxembourg') {
                                                        echo "selected";
                                                      } ?>>Luxembourg</option>
                                              <option <?php if ($row['country'] == 'Madagascar') {
                                                        echo "selected";
                                                      } ?>>Madagascar</option>
                                              <option <?php if ($row['country'] == 'Malawi') {
                                                        echo "selected";
                                                      } ?>>Malawi</option>
                                              <option <?php if ($row['country'] == 'Malaysia') {
                                                        echo "selected";
                                                      } ?>>Malaysia</option>
                                              <option <?php if ($row['country'] == 'Maldives') {
                                                        echo "selected";
                                                      } ?>>Maldives</option>
                                              <option <?php if ($row['country'] == 'Mali') {
                                                        echo "selected";
                                                      } ?>>Mali</option>
                                              <option <?php if ($row['country'] == 'Malta') {
                                                        echo "selected";
                                                      } ?>>Malta</option>
                                              <option <?php if ($row['country'] == 'Marshall Islands') {
                                                        echo "selected";
                                                      } ?>>Marshall Islands</option>
                                              <option <?php if ($row['country'] == 'Mauritania') {
                                                        echo "selected";
                                                      } ?>>Mauritania</option>
                                              <option <?php if ($row['country'] == 'Mauritius') {
                                                        echo "selected";
                                                      } ?>>Mauritius</option>
                                              <option <?php if ($row['country'] == 'Mexico') {
                                                        echo "selected";
                                                      } ?>>Mexico</option>
                                              <option <?php if ($row['country'] == 'Micronesia') {
                                                        echo "selected";
                                                      } ?>>Micronesia</option>
                                              <option <?php if ($row['country'] == 'Moldova') {
                                                        echo "selected";
                                                      } ?>>Moldova</option>
                                              <option <?php if ($row['country'] == 'Monaco') {
                                                        echo "selected";
                                                      } ?>>Monaco</option>
                                              <option <?php if ($row['country'] == 'Mongolia') {
                                                        echo "selected";
                                                      } ?>>Mongolia</option>
                                              <option <?php if ($row['country'] == 'Montenegro') {
                                                        echo "selected";
                                                      } ?>>Montenegro</option>
                                              <option <?php if ($row['country'] == 'Morocco') {
                                                        echo "selected";
                                                      } ?>>Morocco</option>
                                              <option <?php if ($row['country'] == 'Mozambique') {
                                                        echo "selected";
                                                      } ?>>Mozambique</option>
                                              <option <?php if ($row['country'] == 'Myanmar') {
                                                        echo "selected";
                                                      } ?>>Myanmar</option>
                                              <option <?php if ($row['country'] == 'Namibia') {
                                                        echo "selected";
                                                      } ?>>Namibia</option>
                                              <option <?php if ($row['country'] == 'Nauru') {
                                                        echo "selected";
                                                      } ?>>Nauru</option>
                                              <option <?php if ($row['country'] == 'Nepal') {
                                                        echo "selected";
                                                      } ?>>Nepal</option>
                                              <option <?php if ($row['country'] == 'Netherlands') {
                                                        echo "selected";
                                                      } ?>>Netherlands</option>
                                              <option <?php if ($row['country'] == 'New Zealand') {
                                                        echo "selected";
                                                      } ?>>New Zealand</option>
                                              <option <?php if ($row['country'] == 'Nicaragua') {
                                                        echo "selected";
                                                      } ?>>Nicaragua</option>
                                              <option <?php if ($row['country'] == 'Niger') {
                                                        echo "selected";
                                                      } ?>>Niger</option>
                                              <option <?php if ($row['country'] == 'Nigeria') {
                                                        echo "selected";
                                                      } ?>>Nigeria</option>
                                              <option <?php if ($row['country'] == 'North Korea') {
                                                        echo "selected";
                                                      } ?>>North Korea</option>
                                              <option <?php if ($row['country'] == 'North Macedonia') {
                                                        echo "selected";
                                                      } ?>>North Macedonia</option>
                                              <option <?php if ($row['country'] == 'Norway') {
                                                        echo "selected";
                                                      } ?>>Norway</option>
                                              <option <?php if ($row['country'] == 'Oman') {
                                                        echo "selected";
                                                      } ?>>Oman</option>
                                              <option <?php if ($row['country'] == 'Pakistan') {
                                                        echo "selected";
                                                      } ?>>Pakistan</option>
                                              <option <?php if ($row['country'] == 'Palau') {
                                                        echo "selected";
                                                      } ?>>Palau</option>
                                              <option <?php if ($row['country'] == 'Panama') {
                                                        echo "selected";
                                                      } ?>>Panama</option>
                                              <option <?php if ($row['country'] == 'Papua New Guinea') {
                                                        echo "selected";
                                                      } ?>>Papua New Guinea</option>
                                              <option <?php if ($row['country'] == 'Paraguay') {
                                                        echo "selected";
                                                      } ?>>Paraguay</option>
                                              <option <?php if ($row['country'] == 'Peru') {
                                                        echo "selected";
                                                      } ?>>Peru</option>
                                              <option <?php if ($row['country'] == 'Philippines') {
                                                        echo "selected";
                                                      } ?>>Philippines</option>
                                              <option <?php if ($row['country'] == 'Poland') {
                                                        echo "selected";
                                                      } ?>>Poland</option>
                                              <option <?php if ($row['country'] == 'Portugal') {
                                                        echo "selected";
                                                      } ?>>Portugal</option>
                                              <option <?php if ($row['country'] == 'Qatar') {
                                                        echo "selected";
                                                      } ?>>Qatar</option>
                                              <option <?php if ($row['country'] == 'Romania') {
                                                        echo "selected";
                                                      } ?>>Romania</option>
                                              <option <?php if ($row['country'] == 'Russia') {
                                                        echo "selected";
                                                      } ?>>Russia</option>
                                              <option <?php if ($row['country'] == 'Rwanda') {
                                                        echo "selected";
                                                      } ?>>Rwanda</option>
                                              <option <?php if ($row['country'] == 'Saint Kitts and Nevis') {
                                                        echo "selected";
                                                      } ?>>Saint Kitts and Nevis</option>
                                              <option <?php if ($row['country'] == 'Saint Lucia') {
                                                        echo "selected";
                                                      } ?>>Saint Lucia</option>
                                              <option <?php if ($row['country'] == 'Saint Vincent and the Grenadines') {
                                                        echo "selected";
                                                      } ?>>Saint Vincent and the Grenadines</option>
                                              <option <?php if ($row['country'] == 'Samoa') {
                                                        echo "selected";
                                                      } ?>>Samoa</option>
                                              <option <?php if ($row['country'] == 'San Marino') {
                                                        echo "selected";
                                                      } ?>>San Marino</option>
                                              <option <?php if ($row['country'] == 'Sao Tome and Principe') {
                                                        echo "selected";
                                                      } ?>>Sao Tome and Principe</option>
                                              <option <?php if ($row['country'] == 'Saudi Arabia') {
                                                        echo "selected";
                                                      } ?>>Saudi Arabia</option>
                                              <option <?php if ($row['country'] == 'Senegal') {
                                                        echo "selected";
                                                      } ?>>Senegal</option>
                                              <option <?php if ($row['country'] == 'Serbia') {
                                                        echo "selected";
                                                      } ?>>Serbia</option>
                                              <option <?php if ($row['country'] == 'Seychelles') {
                                                        echo "selected";
                                                      } ?>>Seychelles</option>
                                              <option <?php if ($row['country'] == 'Sierra Leone') {
                                                        echo "selected";
                                                      } ?>>Sierra Leone</option>
                                              <option <?php if ($row['country'] == 'Singapore') {
                                                        echo "selected";
                                                      } ?>>Singapore</option>
                                              <option <?php if ($row['country'] == 'Slovakia') {
                                                        echo "selected";
                                                      } ?>>Slovakia</option>
                                              <option <?php if ($row['country'] == 'Slovenia') {
                                                        echo "selected";
                                                      } ?>>Slovenia</option>
                                          </select>
                                        </div>
