...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  $dir = "projectprofiles_upload/";

  $currentMicroTime = microtime(true);
  $currentMillis = round($currentMicroTime * 1000);
  $targetFilePath =  $dir . $currentMillis . "." . basename($_FILES['file']['type']);
  ...
  $sql = "INSERT INTO project_profile (titleprogram, titleproject, typeproject, fundinginstitution, typefundinginstitution, implementingagency, coimplementingagency, positionproject, status, sector, from_project, to_project, projectsite, `file`, added_by) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
  $stmt = mysqli_prepare($conn, $sql);

  if ($stmt) {
    mysqli_stmt_bind_param($stmt, "sssssssssssssss", $titleprogram, $titleproject, $typeproject, $fundinginstitution, $typefundinginstitution, $implementingagency, $coimplementingagency, $positionproject, $status, $sector, $from_project, $to_project, $projectsite, $tmpFile, $added_by);
    if (mysqli_stmt_execute($stmt)) {
      $user_id = $_SESSION['user_id'];
      $category = "project profiles";
      $description = "has added his/her project profiles.";
      $sql = "INSERT INTO `notification`(`user_id`, `category`, `description`) VALUES (?, ?, ?)";
      $stmt = mysqli_stmt_init($conn);
      if (!mysqli_stmt_prepare($stmt, $sql)) {
        header("location: ./projectprofiles.php?error");
        exit();
      }
        ...
        <div class="row page-titles">
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="tableprojectprofiles.php">Project Profile</a>
            </li>
            <li class="breadcrumb-item active">
              <a href="projectprofiles.php">Project Profiles Form</a>
            </li>
          </ol>
        </div>
        <div class="row">
          <div class="col s12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Project Profiles Form</h4>
              </div>
              <div class="card-body">
                <form method="post" action="#" id="project_profile" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-lg-6 mb-3">
                      <label class="form-label">Title of Program
                      </label>
                      <input class="form-control form-control-lg" rows="5" placeholder="If Applicable" name="titleprogram"></input>
                    </div>
                    <div class="col-lg-6 mb-3">
                      <label class="form-label">Title of Project <span class="text-danger">*</span>
                      </label>
                      <input class="form-control form-control-lg" rows="5" placeholder="Title of Project" name="titleproject" required></input>
                    </div>
                    <div class="col-lg-6 mb-3">
                      <label class="form-label">Type of Project </label><span class="text-danger">*</span>
                      </label>
                      <select class="default-select form-control default-select wide" name="typeproject" required>
                    ...
                    <div class="col-lg-6 mb-3">
                      ...
                      <input class="form-control form-control-lg" rows="5" placeholder="(optional)" name="fundinginstitution"></input>
                    </div>
                    <div class="col-lg-6 mb-3">
                      <label class="form-label">Type of Funding Institution <span class="text-danger">*</span>
                      </label>
                      <select class="default-select form-control default-select wide" name="typefundinginstitution" required>
                        <option value="">Select Type of Funding Institution</option>
                        <option>Local</option>
                    ...
                    <div class="col-lg-6 mb-3">
                      ...
                      <input class="form-control form-control-lg" rows="5" placeholder="Implementing Agency" name="implementingagency" required></input>
                    </div>
                    <div class="col-lg-6 mb-3">
                      <label class="form-label">Co Implementing Agency
                      </label>
                      <input class="form-control form-control-lg" rows="5" placeholder="(optional)" name="coimplementingagency"></input>
                    </div>
                    <div class="col-lg-6 mb-3">
                      <label class="form-label">Position in the Project <span class="text-danger">*</span>
                      </label>
                      <select class="default-select form-control default-select wide" name="positionproject" required>
                        <option value="">Select Position Project</option>
                        <option>Co-Program Leader</option>
                        <option>Co-Project Leader</option>
                        <option>Program Coordinator</option>
                        <option>Program Leader</option>
                        <option>Project Leader</option>
                        <option>Research & Development Staff</option>
                        <option>Others</option>
                      </select>
                    </div>
                    <div class="col-lg-4 mb-3">
                      ...
                      <select class="default-select form-control default-select wide" name="status" required>
                        <option value="">Select Status</option>
                        <option>Approved</option>
                        <option>Completed with Terminal Report</option>
                        <option>Completed w/o Terminal Report</option>
                        <option>Deferred (approval)</option>
                        <option>Deferred (impl’n)</option>
                        <option>Disapproved</option>
                        <option>Extended New</option>
                        <option>Ongoing</option>
                        <option>Proposed Reactivated</option>
                        <option>Recommended Rejected</option>
                        <option>Suspended Terminated</option>
                        <option>Terminated with Terminal Report</option>
                        <option>Others</option>
                      </select>
                    </div>
                    <div class="col-lg-4 mb-3">
                      ...
                      <select class="default-select form-control default-select wide" name="sector" required>
                        <option value="">Select Sector</option>
                        <option>Agricultural Resources Management</option>
                        <option>Crops</option>
                        <option>Forestry and Env’t</option>
                        <option>Livestock</option>
                        <option>Sociol-economics</option>
                        <option>Others</option>
                      </select>
                    </div>
                    <div class="col-lg-2 mb-3">
                      ...
                      <input type="date" value="" class="form-control form-control-lg" name="from_project" required>
                    </div>
                    <div class="col-lg-2 mb-4" style="padding-top:28px">
                      <input type="date" value="" class="form-control form-control-lg" name="to_project">
                    </div>
                    <div class="col-lg-12 mb-3">
                      <label class="form-label">Project Site
                      </label>
                      <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="(optional)" name="projectsite"></input>
                    </div>
                    <div class="col-lg-12 mb-3">
                      ...
                      <input type="file" class="form-control form-control-lg" rows="5" name="file" style="padding-top: 10px;" required accept=".pdf"></input>
                    </div>

                    <div class="col-md-2" style="margin-top: 10px;">
                      <button type="submit" class="btn btn-primary mb-2">Submit</button>
                      <a href="tableprojectprofiles.php" type="button" class="btn btn-danger light" data-bs-dismiss="modal">Close</a>
                    </div>
                  </div>
                </form>
              </div>
...
<script src="js/plugins-init/sweetalert.init.js"></script> -->
  ...
  <script>
    document.getElementById("project_profile").addEventListener("submit", function(e) {
    ...
    function showAlert() {
      swal({
        ...
        document.getElementById("project_profile").submit();
      });
