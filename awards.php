...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  echo $award = $_POST['award'];
  echo $rank = $_POST['rank'];
  echo $category = $_POST['category'];
  echo $year_granted = $_POST['year_granted'];
  echo $granting_institution = $_POST['granting_institution'];

  $sql = "INSERT INTO award (`award`, `rank`, `category`, `year_granted`, `granting_institution`, `added_by`) VALUES (?, ?, ?, ?, ?, ?)";
  $stmt = mysqli_prepare($conn, $sql);

  if ($stmt) {
    mysqli_stmt_bind_param($stmt, "ssssss", $award, $rank, $category, $year_granted, $granting_institution, $user_id);
    if (mysqli_stmt_execute($stmt)) {
      // $user_id = $_SESSION['user_id'];
      // $category = "awards";
      // $description = "has added his/her awards.";
      // $sql = "INSERT INTO `notification`(`user_id`, `category`, `description`) VALUES (?, ?, ?)";
      // $stmt = mysqli_stmt_init($conn);
      // if (!mysqli_stmt_prepare($stmt, $sql)) {
      //   header("location: ./awards.php?error");
      //   exit();
      // }
        ...
        <div class="row page-titles">
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="tableawards.php">R&D Awards</a>
            </li>
            <li class="breadcrumb-item active">
              <a href="awards.php">R&D Awards Form</a>
            </li>
          </ol>
        </div>
        <div class="row">
          <div class="col s12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">R&D Awards Form</h4>
              </div>
              <div class="card-body">
                <form method="post" action="#" enctype="multipart/form-data" id="award">
                  <div class="row">
                    <div class="col-lg-12 mb-3">
                      <label class="form-label ">Title of R&D Award <span class="text-danger">*</span>
                      </label>
                      <input class="form-control form-control-lg" rows="5" placeholder="Title of R&D Award" name="award" required></input>
                    </div>
                    <div class="col-lg-4 mb-3">
                      <label class="form-label">Rank <span class="text-danger">*</span>
                      </label>
                      <input class="form-control form-control-lg" rows="5" placeholder="Rank" name="rank" required></input>
                    </div>
                    <div class="col-lg-4 mb-3">
                      <label class="form-label ">Category <span class="text-danger">*</span>
                      </label>
                      <select id="inputState" class="default-select form-control default-select wide" name="category" required>
                    ...
                    <div class="col-lg-12 mb-3">
                      ...
                      <input class="form-control form-control-lg" rows="5" placeholder="Granting Institution" name="granting_institution" required></input>
                    </div>
                    <div class="col-md-2" style="margin-top: 10px;">
                      <button type="submit" class="btn btn-primary mb-2">Submit</button>
                      <a href="tableawards.php" type="button" class="btn btn-danger light" data-bs-dismiss="modal">Close</a>
                    </div>
                  </div>
                </form>
              </div>
...
***********************************-->
  ...
  <script>
    document.getElementById("award").addEventListener("submit", function(e) {
    ...
    function showAlert() {
      swal({
        ...
        document.getElementById("award").submit();
      });
