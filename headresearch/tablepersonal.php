            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="example" class="display">
                  ...
                  <tbody>
                    <?php
                    $query = "SELECT pp.id, pp.title_profile, pp.lastname, pp.firstname, pp.middlename, pp.emailprimary, pp.mobileno FROM personal_profile as pp INNER JOIN faculty_user as fu ON pp.added_by = fu.id ORDER BY id DESC";
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="col-md-4"><?php echo $row["title_profile"] . ' ' . $row["firstname"] . ' ' . $row["middlename"] . ' ' . $row["lastname"]; ?></td>
