                                ...
                                <table id="example" class="display">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="col-md-4" style="padding-left: 260px"><strong>Action</strong></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                          ...
                                          <td class="col-md-4" >Q4</td>
                                            ...
                                            <td class="col-md-4" style="padding-left: 270px">
                                                <a href="annuallypdf.php?id=<?php echo $row['id'] ?>" target="_blank" class="btn btn-dark shadow btn-xs sharp me-1" name="approve" value="approve" ><i class="fas fa-cloud-download-alt" title='Report'></i></a>
                                        </td>
