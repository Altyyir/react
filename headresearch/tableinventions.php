            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="example" class="display">
                  ...
                  <tbody>
                    <?php
                    $query = "SELECT per.id, per.title AS invention_title, per.right_type, per.principal_author, per.date_inventions, fac.title, fac.first_name, fac.middle_name, fac.last_name FROM inventions AS per INNER JOIN faculty_user AS fac ON per.added_by = fac.id ORDER BY id DESC";
