                ...
                <table id="example" class="display">
                  <thead>
                    <tr>
                      ...
                      <th class="col-md-3" style="text-align: center;"><strong>Degree Earned</strong></th>
                      ...
                      <th class="col-md-1" style="text-align: center;"><strong>Status</strong></th>
                      <!-- <th class="col-md-1"><strong>Action</strong></th> -->
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                    $query = "SELECT per.year_end, per.id, per.degree, per.major_field, per.sector, per.status, fac.title, fac.first_name, fac.middle_name, fac.last_name FROM academic_background AS per INNER JOIN faculty_user AS fac ON per.added_by = fac.id ORDER BY id DESC";
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="col-md-1" style="text-align: center;"><?php echo $row["status"] ?></td>
                        <!-- <td class="col-md-1">
                                            <div class="d-flex" >
                                                <div class="d-flex">
                                                ...
                                                <a href="tableacademic.php?id=<?php echo $row['id']; ?>" class="btn btn-dark shadow btn-xs sharp me-1"><i class="fas fa-trash"></i></a>
                                            </div>  -->
                        </td>
                        <!--                                         <div class="modal fade bd-example-modal-lg">
                                            <div class="modal-dialog modal-lg ">
                                                        ...
                                                        <div class="row">
                                                            <div class="col s12">
                                                                 <form method="post" action="#">
                                                                      <div class="row">
                                                                           <hr style="width: 97%; margin-left: 17px; margin-right: 20px; margin-top: -16px; padding: 1px">
                                                                           <div class="row">
                                                                              <div class="col-xl-12">
                                                                                <div class="d-flex justify-content-between flex-wrap">
                                                                                  <div class="input-group contacts-search mb-8">
                                                                                    <h2 style="margin-left: 27px; margin-top: -3px; font-size: 19px; font-weight: 600; color: #000;">Academic Background</h2>
                                                                            ...
                                                                            <div class="col-lg-6 mb-3">
                                                                              <label class="form-label ">Degree Earned (from highest to lowest) <span class="text-danger">*</span>
                                                                               ...
                                                                               <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Degree Earned" name="degree"></input>
                                                                            </div>
                                                                            <div class="col-lg-6 mb-3">
                                                                              <label class="form-label ">Major Field <span class="text-danger">*</span>
                                                                              </label>
                                                                               <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Major Field"  name="major_field"></input>
                                                                            </div>
                                                                            <div class="col-lg-6 mb-3">
                                                                              <label class="form-label ">Sector <span class="text-danger">*</span>
                                                                              </label>
                                                                               <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Sector" name="sector"></input>
                                                                            </div>
                                                                            <div class="col-lg-6 mb-3">
                                                                              <label class="form-label ">Learning Institution <span class="text-danger">*</span>
                                                                              </label>
                                                                               <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Learning Institution" name="institution"></input>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-lg-9 mb-3">
                                                                              <label class="form-label ">Sponsor <span class="text-danger">*</span>
                                                                              </label>
                                                                            ...
                                                                            <div class="col-lg-3 mb-3">
                                                                              <label class="form-label">Primary Sponsor <span class="text-danger">*</span>
                                                                              </label>
                                                                                <select id="inputState" class="default-select form-control default-select wide" name="primary_sponsor" required>
                                                                            ...
                                                                            <div class="col-lg-3 mb-3">
                                                                              <label class="form-label">Scholarship (Start)<span class="text-danger">*</span></label>
                                                                                <input type="date" value="" class="form-control form-control-lg" name="scholarship_start" required>
                                                                            </div>
                                                                            <div class="col-lg-3 mb-3">
                                                                              <label class="form-label">(End) <span class="text-danger">*</span></label>
                                                                                <input type="date" value="" class="form-control form-control-lg" name="scholarship_end" required>
                                                                            </div>
                                                                            <div class="col-lg-3 mb-3">
                                                                              <label class="form-label">Extension Period (Start) <span class="text-danger">*</span></label>
                                                                                <input type="date" value="" class="form-control form-control-lg" name="extension_start" required>
                                                                            </div>
                                                                            <div class="col-lg-3 mb-3">
                                                                              <label class="form-label">(End) <span class="text-danger">*</span></label>
                                                                                <input type="date" value="" class="form-control form-control-lg" name="extension_end" required>
                                                                            </div>
                                                                            <div class="col-lg-3 mb-3">
                                                                              <label class="form-label">Item Expenses <span class="text-danger">*</span></label>
                                                                               <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Item Expenses" name="item_expenses"></input>
                                                                            </div>
                                                                            <div class="col-lg-3 mb-3">
                                                                              <label class="form-label">Amount Approved <span class="text-danger">*</span></label>
                                                                                <input type="number" value="" class="form-control form-control-lg" name="amount_approved" required>
                                                                            </div>
                                                                            <div class="col-lg-3 mb-3">
                                                                              <label class="form-label">Amount Released <span class="text-danger">*</span></label>
                                                                                <input type="number" value="" class="form-control form-control-lg" name="amount_released" required>
                                                                            </div>
                                                                            <div class="col-lg-3 mb-3">
                                                                              <label class="form-label">Date Released <span class="text-danger">*</span></label>
                                                                                <input type="date" value="" class="form-control form-control-lg" name="date_released" required>
                                                                            </div> 
                                                                      </div>
                                                                 </form>
                                                            </div>
