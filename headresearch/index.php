                                            ...
                                            <li>
                                                <div class="timeline-panel">
                                                    ...
                                                    <div class="media-body">
                                                        <h6 class="mb-1" style="font-size:14px; font-weight:600">CICS</h6>
            ...
            <!--                                <input type="text" class="form-control" placeholder="Search here...">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="fs-20 font-w700 mb-2">Research Projects (<?=$_GET['annual']?><?php if($_GET['filterType'] == "quarter") {echo ucwords(" - " . $_GET['quarter']." quarter");}?>)</h4>
                             ...
                             <div class="col-md-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="fs-20 font-w700 mb-2">Faculty Researcher (<?=$_GET['annual']?><?php if($_GET['filterType'] == "quarter") {echo ucwords(" - " . $_GET['quarter']." quarter");}?>)</h4>
                                        <div class="row"></div>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-header">
                                       <h4 class="fs-20 font-w700 mb-2">Conferences Attended (<?=$_GET['annual']?><?php if($_GET['filterType'] == "quarter") {echo ucwords(" - " . $_GET['quarter']." quarter");}?>)</h4>
                                   </div>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="fs-20 font-w700 mb-2">Publication (<?=$_GET['annual']?><?php if($_GET['filterType'] == "quarter") {echo ucwords(" - " . $_GET['quarter']." quarter");}?>)</h4>
                                        <div class="row">
                           ...
                           <div class="col-md-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="fs-20 font-w700 mb-2">R&D Expenditures (<?=$_GET['annual']?><?php if($_GET['filterType'] == "quarter") {echo ucwords(" - " . $_GET['quarter']." quarter");}?>)</h4>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="fs-20 font-w700 mb-2">Inventions (<?=$_GET['annual']?><?php if($_GET['filterType'] == "quarter") {echo ucwords(" - " . $_GET['quarter']." quarter");}?>)</h4>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="fs-20 font-w700 mb-0">Completed Research Projects (<?=$_GET['annual']?><?php if($_GET['filterType'] == "quarter") {echo ucwords(" - " . $_GET['quarter']." quarter");}?>)</h4>
