    ...
    if (isset($_FILES["profile-pic"]) && $_FILES["profile-pic"]["error"] == UPLOAD_ERR_OK) {
      ...
      if ($stmt) {
        ...
        if (mysqli_stmt_execute($stmt)) {
          ...
          $description = "has updated his/her personal profile.";
          ...
          $sql = "SELECT `fu`.`id` FROM `faculty_user` AS `fu` INNER JOIN `college` AS `c` ON `fu`.`college_id` = `c`.`id` WHERE `c`.`abbreviation_college` = ?";
          $stmt = mysqli_stmt_init($conn);
          if (!mysqli_stmt_prepare($stmt, $sql)) {
            header("location: ./personalprofiles.php?error");
            exit();
                                  ...
                                  <form method="post" action="#" enctype="multipart/form-data">
                                    <div class="row mb-3">
                                      <div class="col-3 text-end">
                                        <img class="profile-pic" id="profile-pic" src="<?php if ($row) {
                                    ...
                                    <div class="row">
                                      <div class="col-lg-3 mb-3">
                                        ...
                                        <select id="inputState" class="default-select form-control default-select wide" name="title_profile">
                                          ...
                                          <option <?php if ($row && $row['title_profile'] == "Mr.") {
                                                    echo "selected";
                                                  } ?>>Mr.</option>
                                          <option <?php if ($row && $row['title_profile'] == "Mrs.") {
                                                    echo "selected";
                                                  } ?>>Mrs.</option>
                                          <option <?php if ($row && $row['title_profile'] == "Ms.") {
                                                    echo "selected";
                                                  } ?>>Ms.</option>
                                          <option <?php if ($row && $row['title_profile'] == "Dr.") {
                                                    echo "selected";
                                                  } ?>>Dr.</option>
                                          <option <?php if ($row && $row['title_profile'] == "NS") {
                                                    echo "selected";
                                                  } ?>>NS</option>
                                          <option <?php if ($row && $row['title_profile'] == "Prof.") {
                                                    echo "selected";
                                                  } ?>>Prof.</option>
                                          <option <?php if ($row && $row['title_profile'] == "Rev.") {
                                                    echo "selected";
                                                  } ?>>Rev.</option>
                                          <option <?php if ($row && $row['title_profile'] == "Engr.") {
                                                    echo "selected";
                                                  } ?>>Engr.</option>
                                          <option <?php if ($row && $row['title_profile'] == "Capt.") {
                                                    echo "selected";
                                                  } ?>>Capt.</option>
                                          <option <?php if ($row && $row['title_profile'] == "Mayor") {
                                                    echo "selected";
                                                  } ?>>Mayor</option>
                                          <option <?php if ($row && $row['title_profile'] == "Lt.-Col.") {
                                                    echo "selected";
                                                  } ?>>Lt.-Col.</option>
                                          <option <?php if ($row && $row['title_profile'] == "Col.") {
                                                    echo "selected";
                                                  } ?>>Col.</option>
                                          <option <?php if ($row && $row['title_profile'] == "Lady") {
                                                    echo "selected";
                                                  } ?>>Lady</option>
                                          <option <?php if ($row && $row['title_profile'] == "Lt.-Cmdr.") {
                                                    echo "selected";
                                                  } ?>>Lt.-Cmdr.</option>
                                          <option <?php if ($row && $row['title_profile'] == "The Hon.") {
                                                    echo "selected";
                                                  } ?>>The Hon.</option>
                                          <option <?php if ($row && $row['title_profile'] == "Cmdr.") {
                                                    echo "selected";
                                                  } ?>>Cmdr.</option>
                                          <option <?php if ($row && $row['title_profile'] == "Flt. Lt.") {
                                                    echo "selected";
                                                  } ?>>Flt. Lt.</option>
                                          <option <?php if ($row && $row['title_profile'] == "Brgdr.") {
                                                    echo "selected";
                                                  } ?>>Brgdr.</option>
                                          <option <?php if ($row && $row['title_profile'] == "Judge") {
                                                    echo "selected";
                                                  } ?>>Judge</option>
                                          <option <?php if ($row && $row['title_profile'] == "The Hon. Mrs") {
                                                    echo "selected";
                                                  } ?>>The Hon. Mrs</option>
                                          <option <?php if ($row && $row['title_profile'] == "Wng. Cmdr.") {
                                                    echo "selected";
                                                  } ?>>Wng. Cmdr.</option>
                                          <option <?php if ($row && $row['title_profile'] == "Group Capt.") {
                                                    echo "selected";
                                                  } ?>>Group Capt.</option>
                                          <option <?php if ($row && $row['title_profile'] == "Rt. Hon. Lord") {
                                                    echo "selected";
                                                  } ?>>Rt. Hon. Lord</option>
                                          <option <?php if ($row && $row['title_profile'] == "Revd Father") {
                                                    echo "selected";
                                                  } ?>>Revd Father</option>
                                          <option <?php if ($row && $row['title_profile'] == "Revd Canon") {
                                                    echo "selected";
                                                  } ?>>Revd Canon</option>
                                          <option <?php if ($row && $row['title_profile'] == "Maj. Gen.") {
                                                    echo "selected";
                                                  } ?>>Maj. Gen.</option>
                                          <option <?php if ($row && $row['title_profile'] == "Air Cdre.") {
                                                    echo "selected";
                                                  } ?>>Air Cdre.</option>
                                          <option <?php if ($row && $row['title_profile'] == "Viscount") {
                                                    echo "selected";
                                                  } ?>>Viscount</option>
                                          <option <?php if ($row && $row['title_profile'] == "Dame") {
                                                    echo "selected";
                                                  } ?>>Dame</option>
                                          <option <?php if ($row && $row['title_profile'] == "Rear Admrl.") {
                                                    echo "selected";
                                                  } ?>>Rear Admrl.</option>
                                          <option <?php if ($row && $row['title_profile'] == "Asc prof") {
                                                    echo "selected";
                                                  } ?>>Asc prof</option>
                                          <option <?php if ($row && $row['title_profile'] == "Fr.") {
                                                    echo "selected";
                                                  } ?>>Fr.</option>
                                          <option <?php if ($row && $row['title_profile'] == "Sen.") {
                                                    echo "selected";
                                                  } ?>>Sen.</option>
                                          <option <?php if ($row && $row['title_profile'] == "Sec.") {
                                                    echo "selected";
                                                  } ?>>Sec.</option>
                                          <option <?php if ($row && $row['title_profile'] == "Asst. Prof.") {
                                                    echo "selected";
                                                  } ?>>Asst. Prof.</option>
                                          <option <?php if ($row && $row['title_profile'] == "Sr.") {
                                                    echo "selected";
                                                  } ?>>Sr.</option>
                                          <option <?php if ($row && $row['title_profile'] == "Sir") {
                                                    echo "selected";
                                                  } ?>>Sir</option>
                                        </select>
                                      </div>
                                      <div class="col-md-3 mb-3">
                                        ...
                                        <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Last Name" name="lastname" required value="<?php if ($row) {
                                                                                                                                                                                echo $row['lastname'];
                                                                                                                                                                              } else {
                                                                                                                                                                                echo "";
                                                                                                                                                                              } ?>"></input>
                                      ...
                                      <div class="col-lg-3 mb-3">
                                        ...
                                        <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="First Name" name="firstname" required value="<?php if ($row) {
                                                                                                                                                                                  echo $row['firstname'];
                                                                                                                                                                                } else {
                                                                                                                                                                                  echo "";
                                                                                                                                                                                } ?>"></input>
                                      ...
                                      <div class="col-lg-3 mb-3">
                                        ...
                                        <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Middle Name" name="middlename" value="<?php if ($row) {
                                                                                                                                                                          echo $row['middlename'];
                                                                                                                                                                        } else {
                                                                                                                                                                          echo "";
                                                                                                                                                                        } ?>"></input>
                                      ...
                                      <div class="col-lg-3 mb-3">
                                        ...
                                        <input type="date" class="form-control form-control-lg" name="dateofbirth" required value="<?php if ($row) {
                                      ...
                                      <div class="col-lg-9 mb-3">
                                        ...
                                        <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Place of Birth" name="placeofbirth" value="<?php if ($row) {
                                      ...
                                      <div class="col-lg-3 mb-3">
                                        ...
                                        <select id="inputState" class="default-select form-control default-select wide" name="civilstatus" required>
                                          ...
                                          <option <?php if ($row && $row['civilstatus'] == "Single") {
                                                    echo "selected";
                                                  } ?>>Single</option>
                                          <option <?php if ($row && $row['civilstatus'] == "Married") {
                                                    echo "selected";
                                                  } ?>>Married</option>
                                          <option <?php if ($row && $row['civilstatus'] == "Seperated") {
                                                    echo "selected";
                                                  } ?>>Seperated</option>
                                          <option <?php if ($row && $row['civilstatus'] == "Widow") {
                                                    echo "selected";
                                                  } ?>>Widow</option>
                                          <option <?php if ($row && $row['civilstatus'] == "Annulled") {
                                                    echo "selected";
                                                  } ?>>Annulled</option>
                                          <option <?php if ($row && $row['civilstatus'] == "Widower") {
                                                    echo "selected";
                                                  } ?>>Widower</option>
                                          <option <?php if ($row && $row['civilstatus'] == "Single Parent") {
                                                    echo "selected";
                                      ...
                                      <div class="col-lg-3 mb-3">
                                        ...
                                        <select id="inputState" class="default-select form-control default-select wide" name="gender" required>
                                          ...
                                          <option <?php if ($row && $row['gender'] == "Female") {
                                                    echo "selected";
                                                  } ?>>Female</option>
                                          <option <?php if ($row && $row['gender'] == "Male") {
                                                    echo "selected";
                                                  } ?>>Male</option>
                                        </select>
                                      </div>
                                      <div class="col-lg-3 mb-3">
                                        ...
                                        <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Citizenship" name="citizenship" required value="<?php if ($row) {
                                      ...
                                      <div class="col-lg-3 mb-3">
                                        ...
                                        <input type="number" class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Mobile No." name="mobileno" required value="<?php if ($row) {
                                                                                                                                                                                              echo $row['mobileno'];
                                                                                                                                                                                            } else {
                                                                                                                                                                                              echo "";
                                                                                                                                                                                            } ?>"></input>
                                      ...
                                      <div class="col-lg-6 mb-3">
                                        ...
                                        <input type="email" class="form-control form-control-lg" placeholder="Email" name="emailprimary" required value="<?php if ($row) {
                                                                                                                                                            echo $row['emailprimary'];
                                                                                                                                                          } else {
                                                                                                                                                            echo "";
                                                                                                                                                          } ?>">
                                      </div>
                                      <div class="col-lg-6 mb-3">
                                        ...
                                        <input type="email" class="form-control form-control-lg" placeholder="(optional)" name="emailsecondary" value="<?php if ($row) {
                                                                                                                                                          echo $row['emailsecondary'];
                                                                                                                                                        } else {
                                                                                                                                                          echo "";
                                                                                                                                                        } ?>">
                                      </div>
                                      ...
                                      <div class="col-lg-4 mb-3">
                                        ...
                                        <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Barangay" name="barangay" value="<?php if ($row) {
                                                                                                                                                                      echo $row['barangay'];
                                                                                                                                                                    } else {
                                                                                                                                                                      echo "";
                                                                                                                                                                    } ?>"></row>
                                      ...
                                      <div class="col-lg-4 mb-3">
                                        ...
                                        <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="State/Street/Subdivision" name="sss" value="<?php if ($row) {
                                                                                                                                                                                echo $row['sss'];
                                                                                                                                                                              } else {
                                                                                                                                                                                echo "";
                                                                                                                                                                              } ?>"></input>
                                      ...
                                      <div class="col-lg-4 mb-3">
                                        ...
                                        <input type="number" class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="e.g. 1234" name="zipcode" value="<?php if ($row) {
                                                                                                                                                                                    echo $row['zipcode'];
                                                                                                                                                                                  } else {
                                                                                                                                                                                    echo "";
                                                                                                                                                                                  } ?>"></input>
