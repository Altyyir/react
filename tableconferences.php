                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-md-6 mb-3">
                                            ...
                                            <select id="inputState" class="default-select form-control default-select wide" name="participation" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;">
                                              ...
                                              <option <?php if ($row['participation'] == 'Resource Person') {
                                                        echo "selected";
                                                      } ?>>Resource Person</option>
                                              <option <?php if ($row['participation'] == 'Paper Presenter') {
                                                        echo "selected";
                                                      } ?>>Paper Presenter</option>
                                              <option <?php if ($row['participation'] == 'Poster Presenter') {
                                                        echo "selected";
                                                      } ?>>Poster Presenter</option>
                                              <option <?php if ($row['participation'] == 'Participant') {
                                                        echo "selected";
                                                      } ?>>Participant</option>
                                              <option <?php if ($row['participation'] == 'Others') {
                                                        echo "selected";
                                                      } ?>>Others</option>
                                            </select>
                                          </div>
                                          <div class="col-lg-6 mb-3">
                                            ...
                                            <select id="inputState" class="default-select form-control default-select wide" name="conference" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;">
                                              ...
                                              <option <?php if ($row['conference'] == 'Local - In-house') {
                                                        echo "selected";
                                                      } ?>>Local - In-house</option>
                                              <option <?php if ($row['conference'] == 'Local – Regional') {
                                                        echo "selected";
                                                      } ?>>Local – Regional</option>
                                              <option <?php if ($row['conference'] == 'Local – National') {
                                                        echo "selected";
                                                      } ?>>Local – National</option>
                                              <option <?php if ($row['conference'] == 'International') {
                                                        echo "selected";
                                                      } ?>>International</option>
                                              <option <?php if ($row['conference'] == 'Others') {
                                                        echo "selected";
                                                      } ?>>Others</option>
                                            </select>
                                          </div>
