                                ...
                                <table id="example5" class="display">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="col-md-3" style="text-align: center;"><strong>Sponsor</strong></th>
                                            <th class="col-md-2" style="text-align: center;"><strong>Type of Participation</strong></th>
                                    ...
                                    <tbody>
                                        <?php 
                                                $query = "SELECT * FROM conferences WHERE added_by = {$user_id} ORDER BY `id` DESC";
                                        ...
                                        <tr>
                                           ...
                                           <td class="col-md-3"><?php echo $row["themetitle"]?></td>
                                           <td class="col-md-3" style="text-align: center;"><?php echo $row["organizer"]?></td>
                                            <td class="col-md-2" style="text-align: center;"><?php echo $row["participation"]?></td>
                                            <?php
                                            $from_conference = strtotime($row['from_conference']);
                                            $from_conference = date("M d, Y", $from_conference);    
                                            $to_conference = strtotime($row['to_conference']);
                                            $to_conference = date("M d, Y", $to_conference);
                                        
                                            ?>
                                            <td class="col-md-2" style="text-align: center;" ><?php echo $from_conference . " - " . $to_conference; ?></td>
                                            <td class="col-md-1">
                                                    ...
                                                    <div id="edit-modal-<?=$row['id']?>" class="modal fade bd-example-modal-lg">
                                                        <div class="modal-dialog modal-lg ">
                                                            <div class="modal-content">
                                                                <form method="post" action="edit.conferences.php">
                                                                <input type="hidden" name="id" value="<?=$row['id']?>">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" style="font-size: 23px">Update Conferences</h5>
                                                                </div>
                                                                <div class="modal-body" style="overflow-y: scroll; max-height: calc(100vh - 200px);">
                                                                    <div class="row">
                                                                        <div class="col-md-12 mb-3">
                                                                            <label class="form-label">Theme/Title</label>
                                                                            <input class="form-control form-control-lg" rows="5" placeholder="Theme/Title"  name="themetitle" value="<?=$row['themetitle']?>"></input>
                                                                        </div>
                                                                        <div class="col-md-12 mb-3">
                                                                            <label class="form-label">Sponsor
                                                                             </label>
                                                                            <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Sponsor" name="organizer" value="<?=$row['organizer']?>"></input>
                                                                        </div>
                                                                        <div class="col-md-12 mb-3">
                                                                            <label class="form-label">Conferences Title 
                                                                             </label>
                                                                            <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Conferences Title"  name="conference_title" value="<?=$row['conference_title']?>"></input>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-md-12 mb-3">
                                                                            <label class="form-label">Venue</label>
                                                                             <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Venue" name="venue" value="<?=$row['venue']?>"></input>
                                                                        </div>
                                                                        <div class="col-md-6 mb-3">
                                                                            <label class="form-label">Type of Participation</label>
                                                                              <select id="inputState" class="default-select form-control default-select wide" name="participation" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;">
                                                                                ...
                                                                                <option <?php if($row['participation'] == 'Resource Person'){echo "selected";}?>>Resource Person</option>
                                                                                <option <?php if($row['participation'] == 'Paper Presenter'){echo "selected";}?>>Paper Presenter</option>
                                                                                <option <?php if($row['participation'] == 'Poster Presenter'){echo "selected";}?>>Poster Presenter</option>
                                                                                <option <?php if($row['participation'] == 'Participant'){echo "selected";}?>>Participant</option>
                                                                                <option <?php if($row['participation'] == 'Others'){echo "selected";}?>>Others</option>
                                                                                </select>
                                                                        </div>
                                                                        <div class="col-lg-6 mb-3">
                                                                           <label class="form-label">Level of Conference
                                                                            ...
                                                                            <select id="inputState" class="default-select form-control default-select wide" name="conference" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;">
                                                                                ...
                                                                                <option <?php if($row['conference'] == 'Local - In-house'){echo "selected";}?>>Local - In-house</option>
                                                                                <option <?php if($row['conference'] == 'Local – Regional'){echo "selected";}?>>Local – Regional</option>
                                                                                <option <?php if($row['conference'] == 'Local – National'){echo "selected";}?>>Local – National</option>
                                                                                <option <?php if($row['conference'] == 'International'){echo "selected";}?>>International</option>
                                                                                <option <?php if($row['conference'] == 'Others'){echo "selected";}?>>Others</option>
                                                                              </select>
                                                                          </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="col-lg-6 mb-3">
                                                                            <label class="form-label">From
                                                                             ...
                                                                             <input type="date" class="form-control form-control-lg" name="from_conference" value="<?=$row['from_conference']?>">
                                                                        </div>
                                                                         <div class="col-lg-6 mb-3">
                                                                            <label class="form-label">To
                                                                            </label>
                                                                             <input type="date" class="form-control form-control-lg" name="to_conference" value="<?=$row['to_conference']?>">
                                                                          </div>
                                                                    </div>  
                                                                </div>
        ...
        function deleteRecord(e) {
            ...
            .then((result) => {
              if(result) {
                ...
                deleteRecord.open("GET", "delete.record.php?table=conferences&id="+e); // yung pangalan lang ng table ang papalitan 
                deleteRecord.send();
