    ...
    if(isset($_GET['id']))
        {
            $id = $_GET['id'];
                ...
                $query = "DELETE FROM academic_background WHERE id='$id'";
...
<!--                                <input type="text" class="form-control" placeholder="Search here...">
                                ...
                                <div class="mb-4">
                                    <a href="academicbackground.php" type="button" class="btn btn-primary btn-rounded fs-16"><i class="fas fa-plus me-3 scale4" style="color: #fff;"></i>Add Academic Background</a>
                                  </div>
                            </div>
                        </div>
                    </div>              
                                ...
                                <table id="example5" class="display">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="col-md-3"><strong>Degree Earned</strong></th>
                                            <th class="col-md-3" style="text-align: center;"><strong>Major Field</strong></th>
                                            <th class="col-md-2" style="text-align: center;"><strong>Sector</strong></th>
                                            <th class="col-md-2" style="text-align: center;"><strong>Status</strong></th>
                                            <th class="col-md-1"><strong>Action</strong></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php 
                                            $query = "SELECT * FROM academic_background WHERE added_by = {$user_id} ORDER BY `id` DESC";
                                         ...
                                         <tr>
                                           ...
                                           <td class="col-md-3"><?php echo $row["degree"]?></td>
                                          <td class="col-md-3" style="text-align: center;"><?php echo $row["major_field"]?></td>
                                            <td class="col-md-2" style="text-align: center;"><?php echo $row["sector"]?></td>
                                            <td class="col-md-2" style="text-align: center;" ><?php echo $row["status"] ?></td>
                                            <td class="col-md-1">
                                            <div class="d-flex" >
                                                <div class="d-flex">
                                                    ...
                                                    <div id="edit-modal-<?=$row['id']?>" class="modal fade bd-example-modal-lg">
                                                        <div class="modal-dialog modal-lg ">
                                                            <div class="modal-content">
                                                              <form method="post" action="edit.academic.php">
                                                                <input type="hidden" name="id" value="<?=$row['id']?>">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" style="font-size: 23px">Update Academic Background</h5>
                                                                </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-12 mb-3">
                                                                              <label class="form-label ">Degree Earned (from highest to lowest) <span class="text-danger">*</span>
                                                                               ...
                                                                               <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Degree Earned" name="degree" value="<?=$row['degree']?>"></input>
                                                                            </div>
                                                                        <div class="col-lg-12 mb-3">
                                                                              <label class="form-label ">Major Field <span class="text-danger">*</span>
                                                                              </label>
                                                                               <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Major Field"  name="major_field" value="<?=$row['major_field']?>"></input>
                                                                            </div>
                                                                            <div class="col-lg-12 mb-3">
                                                                              <label class="form-label ">Sector <span class="text-danger">*</span>
                                                                              </label>
                                                                               <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Sector" name="sector" value="<?=$row['sector']?>"></input>
                                                                            </div>
                                                                            <div class="col-lg-12 mb-3">
                                                                              <label class="form-label ">Learning Institution <span class="text-danger">*</span>
                                                                              </label>
                                                                               <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Learning Institution" name="institution" value="<?=$row['institution']?>"></input>
                                                                            </div>
                                                                            <div class="col-lg-4 mb-3">
                                                                              <label class="form-label">Status <span class="text-danger">*</span>
                                                                              </label>
                                                                                <select id="inputState" class="default-select form-control default-select wide" name="status" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;" required>
                                                                                  <option>Choose Status</option>
                                                                                  <option <?php if($row['status'] == 'Graduated'){echo "selected";}?>>Graduated</option>
                                                                                  <option <?php if($row['status'] == 'Ongoing'){echo "selected";}?>>Ongoing</option>
                                                                                  <option <?php if($row['status'] == 'Dropped'){echo "selected";}?>>Dropped</option>
                                                                                  <option <?php if($row['status'] == 'Termminated'){echo "selected";}?>>Termminated</option>
                                                                                  <option <?php if($row['status'] == 'Others'){echo "selected";}?>>Others</option>
                                                                                </select>
                                                                            </div>
                                                                            <div class="col-lg-4 mb-3">
                                                                              <label class="form-label">Year Taken (Start)<span class="text-danger">*</span></label>
                                                                                <input type="date" class="form-control form-control-lg" name="year_start" value="<?=$row['year_start']?>"required>
                                                                            </div>
                                                                            <div class="col-lg-4 mb-3">
                                                                              <label class="form-label">(End) <span class="text-danger">*</span></label>
                                                                                <input type="date" class="form-control form-control-lg" name="year_end" value="<?=$row['year_end']?>" required>
                                                                            </div>
                                                                            <div class="col-lg-12 mb-3">
                                                                              <label class="form-label ">Thesis <span class="text-danger">*</span>
                                                                              </label>
                                                                               <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Thesis Title" name="thesis" value="<?=$row['thesis']?>"></input>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-lg-9 mb-3">
                                                                              <label class="form-label ">Sponsor</label>
                                                                               <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Sponsor" name="sponsor_academic" value="<?=$row['sponsor_academic']?>"></input>
                                                                            </div>
                                                                            <div class="col-lg-3 mb-3">
                                                                              <label class="form-label">Primary Sponsor
                                                                              </label>
                                                                                <select id="inputState" class="default-select form-control default-select wide" name="primary_sponsor" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;">
                                                                                  <option>Choose Primary Sponsor</option>
                                                                                  <option <?php if($row['primary_sponsor'] == 'Yes'){echo "selected";}?>>Yes</option>
                                                                                  <option <?php if($row['primary_sponsor'] == 'No'){echo "selected";}?>>No</option>
                                                                                </select>
                                                                            </div>
                                                                            <div class="col-lg-3 mb-3">
                                                                              <label class="form-label">Scholarship (Start)</label>
                                                                                <input type="date" class="form-control form-control-lg" name="scholarship_start" value="<?=$row['scholarship_start']?>">
                                                                            </div>
                                                                            <div class="col-lg-3 mb-3">
                                                                              <label class="form-label">(End)</label>
                                                                                <input type="date" class="form-control form-control-lg" name="scholarship_end" value="<?=$row['scholarship_end']?>">
                                                                            </div>
                                                                            <div class="col-lg-3 mb-3">
                                                                              <label class="form-label">Extension Period (Start)</label>
                                                                                <input type="date" class="form-control form-control-lg" name="extension_start" value="<?=$row['extension_start']?>"> 
                                                                            </div>
                                                                            <div class="col-lg-3 mb-3">
                                                                              <label class="form-label">(End)</label>
                                                                                <input type="date" class="form-control form-control-lg" name="extension_end" value="<?=$row['extension_end']?>">
                                                                            </div>
                                                                            <div class="col-lg-3 mb-3">
                                                                              <label class="form-label">Item Expenses</label>
                                                                               <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Item Expenses" name="item_expenses" value="<?=$row['item_expenses']?>"></input>
                                                                            </div>
                                                                            <div class="col-lg-3 mb-3">
                                                                              <label class="form-label">Amount Approved</label>
                                                                                <input type="number" class="form-control form-control-lg" name="amount_approved" value="<?=$row['amount_approved']?>">
                                                                            </div>
                                                                            <div class="col-lg-3 mb-3">
                                                                              <label class="form-label">Amount Released</label>
                                                                                <input type="number" class="form-control form-control-lg" name="amount_released" value="<?=$row['amount_released']?>">
                                                                            </div>
                                                                            <div class="col-lg-3 mb-3">
                                                                              <label class="form-label">Date Released</label>
                                                                                <input type="date" class="form-control form-control-lg" name="date_released" value="<?=$row['date_released']?>">
                                                                            </div> 
                                                                    </div>  
                                                                </div>
