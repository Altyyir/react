                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-lg-4 mb-3">
                                            ...
                                            <select id="inputState" class="default-select form-control default-select wide" name="status" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;" required>
                                              ...
                                              <option <?php if ($row['status'] == 'Graduated') {
                                                        echo "selected";
                                                      } ?>>Graduated</option>
                                              <option <?php if ($row['status'] == 'Ongoing') {
                                                        echo "selected";
                                                      } ?>>Ongoing</option>
                                              <option <?php if ($row['status'] == 'Dropped') {
                                                        echo "selected";
                                                      } ?>>Dropped</option>
                                              <option <?php if ($row['status'] == 'Termminated') {
                                                        echo "selected";
                                                      } ?>>Termminated</option>
                                          ...
                                          <div class="col-lg-3 mb-3">
                                            ...
                                            <select id="inputState" class="default-select form-control default-select wide" name="primary_sponsor" style="border-radius: 1rem; border: 0.0625rem solid #9DB2BF; color: #000;">
                                              ...
                                              <option <?php if ($row['primary_sponsor'] == 'Yes') {
                                                        echo "selected";
                                                      } ?>>Yes</option>
                                              <option <?php if ($row['primary_sponsor'] == 'No') {
                                                        echo "selected";
                                                      } ?>>No</option>
                                            </select>
                                          </div>
