				                ...
				                <table id="example" class="tableResearch">
				                    <thead>
				                        <tr>
				                            ...
				                            <th style="width: 300px;" class='titleHeader'><strong>Project Title</strong></th>
				                    	...
				                    	while($row = mysqli_fetch_array($result)) {
				                	 	...
				                	 	<tr>
					                      ...
					                      <td class="center-align">
					                      	<div class="d-flex" style="align-items: center;"><div class="d-flex">
												<a href="kanban.php?approve&Id=<?php echo $row['Id']; ?>" class="btn btn-primary shadow btn-xs sharp me-1" name="approve" value="approve" ><i class="fas fa-eye"></i></a>
												<a href="#" class="btn btn-info shadow btn-xs sharp" data-bs-toggle="modal" data-bs-target="#exampleModalCenter"><i class="fas fa-comments"></i></a>
											</div>
