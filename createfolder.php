...
if(isset($_GET['id']))
      {
          $id = $_GET['id'];
              ...
              $query = "DELETE FROM create_folder WHERE id='$id'";
              ...
              <div class="mb-4">
                                  ...
                                  <div class="col-lg-12 mb-3">
                                   <label class="form-label">Filter by
                                    ...
                                    <select class="form-control" name="annual">
                                        ...
                                        <?php
                                        $sql = "SELECT DISTINCT(YEAR(dateAdded)) AS year FROM research_topic";
                                        $result = $conn->query($sql);
                ...
                <button type="button" class="btn btn-primary btn-rounded fs-16" data-bs-toggle="modal" data-bs-target="#exampleModalCenter"><i class="fas fa-plus me-3 scale4" style="color: #fff;"></i>Add Project</a></button>
                  ...
                  <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-hidden="true">
                     <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            <form action="create.folder.php" method="post" id="add-folder-form">
                              <div class="modal-header">
                              ...
                              <div class="modal-body">
                                <div class="row">
                                      ...
                                      <input type="text" name="createfolder" id="folder-name" class="form-control form-control-lg" placeholder="New Folder" required>
                                  </div>
                              </div>
                              <div class="modal-footer">
                                  <button type="button" class="btn btn-danger light" data-bs-dismiss="modal">Close</button>
...
<?php 
$userID = $_SESSION['user_id'];
$sql = "SELECT * FROM create_folder WHERE added_by = $userID ORDER BY id DESC";
...
<div class="modal fade" id="exampleModalCenter1" tabindex="-1" role="dialog" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered1" role="document">
        <div class="modal-content">
            ...
            <form action="rename.folder.php" method="post" id="rename-form">
              <div class="modal-body">
              ...
              <div class="modal-footer">
                  <button type="button" class="btn btn-danger light" data-bs-dismiss="modal">Close</button>
                  <button type="submit" id="rename-save" class="btn btn-primary" name="renameFolder">Save Changes</button>
              </div>
            </form>
    </div>
</div>
...
***********************************-->
  ...
  <script src="vendor/lightgallery/js/lightgallery-all.min.js"></script>
    ...
    <script>
        ...
        document.getElementById("add-folder-form").addEventListener("submit", function(event) {
          event.preventDefault(); 
          var folderName = document.getElementById("folder-name").value;
          var checkFolderName = new XMLHttpRequest();
          checkFolderName.open("POST", "check.folder.name.php");
          checkFolderName.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
          checkFolderName.send("folder="+folderName);
          checkFolderName.onload = function() {
            ...
            if(value == "true") {
              ...
              document.getElementById("add-folder-form").submit();
            }
          }
        });
