                      ...
                      <table id="example5" class="display">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="col-md-3" style="text-align: center;">
                                <img src="./profile_upload/<?php if($row['profile_pic'] == ""){echo "images/bsu.png";}else{echo $row['profile_pic'];}?>" width="25" alt="" style="margin-right: 5px; border-radius: 13px;"> You created 
                            </td>
                            <td class="col-md-2">
