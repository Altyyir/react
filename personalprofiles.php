                 ...
                 <form method="post" action="#" enctype="multipart/form-data" id="personalprofiles">
                    <div class="row mb-3">
                      <div class="col-3 text-end">
                        <img class="profile-pic" id="profile-pic" src="<?php if($user_row) {echo $user_row['profile_pic'];} else {echo "images/profile.jpeg";}?>" width="170" height="170">
                      </div>
                      ...
                      <div class="col-9">
                        <div class="row">
                          ...
                          <input type="file" class="form-control form-control-lg" id="validationCustom04" rows="5" name="profile-pic" style="padding-top: 10px;" accept=".jpg, .png, .jpeg" multiple onchange="displayImage(event)"<?php if($user_row) {echo "disabled";}?>>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="row">
                        <div class="col-lg-3 mb-3">
                            ...
                            <select class="default-select form-control default-select wide" name="title_profile" <?php if($user_row) {echo "disabled";}?>>
                              <option value="">Select Title</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Mr.") {echo "selected";}?>>Mr.</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Mrs.") {echo "selected";}?>>Mrs.</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Ms.") {echo "selected";}?>>Ms.</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Dr.") {echo "selected";}?>>Dr.</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "NS") {echo "selected";}?>>NS</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Prof.") {echo "selected";}?>>Prof.</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Rev.") {echo "selected";}?>>Rev.</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Engr.") {echo "selected";}?>>Engr.</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Capt.") {echo "selected";}?>>Capt.</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Mayor") {echo "selected";}?>>Mayor</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Lt.-Col.") {echo "selected";}?>>Lt.-Col.</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Col.") {echo "selected";}?>>Col.</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Lady") {echo "selected";}?>>Lady</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Lt.-Cmdr.") {echo "selected";}?>>Lt.-Cmdr.</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "The Hon.") {echo "selected";}?>>The Hon.</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Cmdr.") {echo "selected";}?>>Cmdr.</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Flt. Lt.") {echo "selected";}?>>Flt. Lt.</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Brgdr.") {echo "selected";}?>>Brgdr.</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Judge") {echo "selected";}?>>Judge</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "The Hon. Mrs") {echo "selected";}?>>The Hon. Mrs</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Wng. Cmdr.") {echo "selected";}?>>Wng. Cmdr.</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Group Capt.") {echo "selected";}?>>Group Capt.</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Rt. Hon. Lord") {echo "selected";}?>>Rt. Hon. Lord</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Revd Father") {echo "selected";}?>>Revd Father</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Revd Canon") {echo "selected";}?>>Revd Canon</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Maj. Gen.") {echo "selected";}?>>Maj. Gen.</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Air Cdre.") {echo "selected";}?>>Air Cdre.</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Viscount") {echo "selected";}?>>Viscount</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Dame") {echo "selected";}?>>Dame</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Rear Admrl.") {echo "selected";}?>>Rear Admrl.</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Asc prof") {echo "selected";}?>>Asc prof</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Fr.") {echo "selected";}?>>Fr.</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Sen.") {echo "selected";}?>>Sen.</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Sec.") {echo "selected";}?>>Sec.</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Asst. Prof.") {echo "selected";}?>>Asst. Prof.</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Sr.") {echo "selected";}?>>Sr.</option>
                              <option <?php if($user_row && $user_row['title_profile'] == "Sir") {echo "selected";}?>>Sir</option>
                            </select>
                          </div>
                          <div class="col-md-3 mb-3">
                            <label class="form-label ">Last Name <span class="text-danger">*</span>
                            </label>
                             <input class="form-control form-control-lg" rows="5" placeholder="Last Name"  name="lastname" value="<?php if($user_row) {echo $user_row['lastname'];} else {echo "";}?>" <?php if($user_row) {echo "disabled";}?>></input>
                          </div>
                          <div class="col-lg-3 mb-3">
                            <label class="form-label ">First Name <span class="text-danger">*</span>
                            </label>
                             <input class="form-control form-control-lg" rows="5" placeholder="First Name" name="firstname" value="<?php if($user_row) {echo $user_row['firstname'];} else {echo "";}?>" <?php if($user_row) {echo "disabled";}?>></input>
                          </div>
                          <div class="col-lg-3 mb-3">
                            <label class="form-label ">Middle Name 
                            </label>
                             <input class="form-control form-control-lg" rows="5" placeholder="Middle Name" name="middlename" value="<?php if($user_row) {echo $user_row['middlename'];} else {echo "";}?>" <?php if($user_row) {echo "disabled";}?>></input>
                          </div>
                          <div class="col-lg-3 mb-3">
                            <label class="form-label">Date of birth <span class="text-danger">*</span>
                            </label>
                            <input type="date" class="form-control form-control-lg" name="dateofbirth" value="<?php if($user_row) {echo $user_row['dateofbirth'];} else {echo "";}?>" <?php if($user_row) {echo "disabled";}?>>
                          </div>
                          <div class="col-lg-9 mb-3">
                            <label class="form-label ">Place of Birth <span class="text-danger">*</span>
                            </label>
                             <input class="form-control form-control-lg" rows="5" placeholder="Place of Birth" name="placeofbirth" value="<?php if($user_row) {echo $user_row['placeofbirth'];} else {echo "";}?>" <?php if($user_row) {echo "disabled";}?>></input>
                          </div>
                          <div class="col-lg-3 mb-3">
                            <label class="form-label">Civil Status <span class="text-danger">*</span>
                            </label>
                          <select class="default-select form-control default-select wide" name="civilstatus"<?php if($user_row) {echo "disabled";}?>>
                                <option value="" >Choose Civil Status</option>
                                <option <?php if($user_row && $user_row['civilstatus'] == "Single") {echo "selected";}?>>Single</option>
                                <option <?php if($user_row && $user_row['civilstatus'] == "Married") {echo "selected";}?>>Married</option>
                                <option <?php if($user_row && $user_row['civilstatus'] == "Seperated") {echo "selected";}?>>Seperated</option>
                                <option <?php if($user_row && $user_row['civilstatus'] == "Widow") {echo "selected";}?>>Widow</option>
                                <option <?php if($user_row && $user_row['civilstatus'] == "Annulled") {echo "selected";}?>>Annulled</option>
                                <option <?php if($user_row && $user_row['civilstatus'] == "Widower") {echo "selected";}?>>Widower</option>
                                <option <?php if($user_row && $user_row['civilstatus'] == "Single Parent") {echo "selected";}?>>Single Parent</option>
                              </select>
                          </div>
                          <div class="col-lg-3 mb-3">
                            <label class="form-label">Gender <span class="text-danger">*</span>
                            </label>
                              <select class="default-select form-control default-select wide" name="gender" <?php if($user_row) {echo "disabled";}?>>
                                <option value="">Choose Gender</option>
                                <option <?php if($user_row && $user_row['gender'] == "Female") {echo "selected";}?>>Female</option>
                                <option <?php if($user_row && $user_row['gender'] == "Male") {echo "selected";}?>>Male</option>
                              </select>
                          </div>
                          <div class="col-lg-3 mb-3">
                            <label class="form-label ">Citizenship <span class="text-danger">*</span>
                            </label>
                             <input class="form-control form-control-lg" rows="5" placeholder="Citizenship" name="citizenship" value="<?php if($user_row) {echo $user_row['citizenship'];} else {echo "";}?>" <?php if($user_row) {echo "disabled";}?>></input>
                          </div>
                          <div class="col-lg-3 mb-3">
                            <label class="form-label ">Mobile No. <span class="text-danger">*</span>
                            </label>
                             <input type="number" class="form-control form-control-lg" rows="5" placeholder="Mobile No." name="mobileno" value="<?php if($user_row) {echo $user_row['mobileno'];} else {echo "";}?>" <?php if($user_row) {echo "disabled";}?>></input>
                          </div>
                          <div class="col-lg-6 mb-3">
                             <label class="form-label">Email (Primary)<span class="text-danger">*</span>
                             </label>
                            <input type="email" class="form-control form-control-lg" placeholder="Email" name="emailprimary" value="<?php if($user_row) {echo $user_row['emailprimary'];} else {echo "";}?>" <?php if($user_row) {echo "disabled";}?>>
                          </div>
                          <div class="col-lg-6 mb-3">
                             <label class="form-label">Email (Secondary)
                             </label>
                            <input type="email" class="form-control form-control-lg" placeholder="(optional)" name="emailsecondary" value="<?php if($user_row) {echo $user_row['emailsecondary'];} else {echo "";}?>" <?php if($user_row) {echo "disabled";}?>>
                          </div>
                          <div class="col-lg-6 mb-3">
                              <label class="form-label">Region <span class="text-danger">*</span></label>
                              <select id="regionSelect" class="default-select form-control default-select wide" name="region"<?php if($user_row) {echo "disabled";}?>>
                                <option value="">Choose Region</option>
                                <option <?php if($user_row && $user_row['region'] == "NCR") {echo "selected";}?> value="NCR">National Capital Region (NCR)</option>
                                <option <?php if($user_row && $user_row['region'] == "CAR") {echo "selected";}?> value="CAR">Cordillera Administrative Region (CAR)</option>
                                <option <?php if($user_row && $user_row['region'] == "ILOCOS") {echo "selected";}?> value="ILOCOS">Region I (ILOCOS REGION)</option>
                                <option <?php if($user_row && $user_row['region'] == "CAGAYAN") {echo "selected";}?> value="CAGAYAN">Region II (CAGAYAN VALLEY)</option>
                                <option <?php if($user_row && $user_row['region'] == "CENTRAL") {echo "selected";}?> value="CENTRAL">Region III (CENTRAL LUZON)</option>
                                <option <?php if($user_row && $user_row['region'] == "CALABARZON") {echo "selected";}?> value="CALABARZON">Region IV-A (CALABARZON)</option>
                                <option <?php if($user_row && $user_row['region'] == "MIMAROPA") {echo "selected";}?> value="MIMAROPA">Region IV-B (MIMAROPA)</option>
                                <option <?php if($user_row && $user_row['region'] == "BICOL") {echo "selected";}?> value="BICOL">Region V (BICOL REGION)</option>
                                <option <?php if($user_row && $user_row['region'] == "WESTERN") {echo "selected";}?> value="WESTERN">Region VI (WESTERN VISAYAS)</option>
                                <option <?php if($user_row && $user_row['region'] == "CENTRAL_VISAYAS") {echo "selected";}?> value="CENTRAL_VISAYAS">Region VII (CENTRAL VISAYAS)</option>
                                <option <?php if($user_row && $user_row['region'] == "EASTERN") {echo "selected";}?> value="EASTERN">Region VIII (EASTERN VISAYAS)</option>
                                <option <?php if($user_row && $user_row['region'] == "ZAMBOANGA") {echo "selected";}?> value="ZAMBOANGA">Region IX (ZAMBOANGA PENINSULA)</option>
                                <option <?php if($user_row && $user_row['region'] == "NORTHERN") {echo "selected";}?> value="NORTHERN">Region X (NORTHERN MINDANAO)</option>
                                <option <?php if($user_row && $user_row['region'] == "DAVAO") {echo "selected";}?> value="DAVAO">Region XI (DAVAO REGION)</option>
                                <option <?php if($user_row && $user_row['region'] == "SOCCSKSARGEN") {echo "selected";}?> value="SOCCSKSARGEN">Region XII (SOCCSKSARGEN)</option>
                                <option <?php if($user_row && $user_row['region'] == "CARAGA") {echo "selected";}?> value="CARAGA">Region XIII (CARAGA)</option>
                                <option <?php if($user_row && $user_row['region'] == "BARMM") {echo "selected";}?> value="BARMM">Bangsamora Autonomous Region in Muslim Mindanao (BARMM)</option>
                                <!-- Add other regions as needed -->
                              </select>
                            </div>
                            <div class="col-lg-6 mb-3">
                              <label class="form-label">Province <span class="text-danger">*</span></label>
                              <select id="provinceSelect" class="default-select form-control default-select wide" name="province" required <?php if($user_row) {echo "disabled";}?>>
                          ...
                          <div class="col-lg-4 mb-3">
                            <label class="form-label ">Barangay
                             ...
                             <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Barangay"  name="barangay" value="<?php if($user_row) {echo $user_row['barangay'];} else {echo "";}?>" <?php if($user_row) {echo "disabled";}?>></input>
                          </div>
                          <div class="col-lg-4 mb-3">
                            <label class="form-label ">State/Street/Subdivision
                            </label>
                             <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="State/Street/Subdivision" name="sss" value="<?php if($user_row) {echo $user_row['sss'];} else {echo "";}?>" <?php if($user_row) {echo "disabled";}?>></input>
                          </div>
                           <div class="col-lg-4 mb-3">
                            <label class="form-label ">Zip Code
                            </label>
                             <input type="number" class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="e.g. 1234"  name="zipcode" value="<?php if($user_row) {echo $user_row['zipcode'];} else {echo "";}?>" <?php if($user_row) {echo "disabled";}?>></input>
                          </div>
