...
(function (factory) {
  ...
  const defaults = {
      ...
      toolbar: {
          ...
          extraHtml: '<button id="submit" class="btn btn-success" style="background: green" type="submit" name="submit">Submit</button>' // Extra html to show on toolbar
      },
      anchor: {
  ...
  class SmartWizard {
      ...
      _createToolbar(position) {
          ...
          const btnNext       = this.options.toolbar.showNextButton !== false ? $('<button></button>').text(this.options.lang.next).addClass('btn ' + this.options.style.btnNextCss + ' ' + this.options.style.btnCss).attr('type', 'button').attr('style', 'display: inline') : null;
      ...
      _setButtons(idx) {
          ...
          this.main.find('.' + this.options.style.btnNextCss + ', .' + this.options.style.btnPrevCss).attr('style', 'display: inline');
          ...
          if (p === 'first' || p === 'last') {
              ...
              this.main.find(c).attr('style', 'display: none');
              if(p === 'last') {
                document.getElementById('submit').setAttribute('style', 'display: inline; background: green');
              } else {
                document.getElementById('submit').setAttribute('style', 'display: none');
              }
