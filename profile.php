                    ...
                    <div class="col-lg-10" style="padding-top: 60px; padding-left: 200px">
                        <div class="profile card card-body px-3 pt-3 pb-0">
                            <div class="profile-head">
	                                ...
	                                <div class="profile-info justify-content-center">
										<div class="profile-photo">
											<?php 
												...
												$row = $result->fetch_assoc();
				                             ?>
										  <img src="profile_upload/<?php echo $row['image_path'] != "" ? $row['image_path'] : 'profile_upload/bsu.png'; ?>" style="aspect-ratio: 1;" class="img-fluid rounded-circle" alt="">
                                ...
                                <?php 
	                            	$id = $_SESSION['user_id'];
	                            	$sql = "SELECT fu.*, c.college_name FROM `faculty_user` AS `fu` INNER JOIN `college` AS `c` ON fu.college_id = c.id WHERE fu.`id` = $id";
									$result = $conn->query($sql);
									$row = $result->fetch_assoc();
	                             ?>
								...
								<div class="row">
									<h4 style="font-size:16px; text-align: center;"><?php echo $row["college_name"] ?></h4>
								</div>
								<div>
								<div class="row">
								<div class="col mb-4" style="padding-top: 25px; padding-left: 242px">
                                                ...
                                                <div class="modal-body">
                                                	<div class="row">
                                                        ...
                                                        <div class="col-md-12" style="margin-top: 10px">
                                                        	...
                                                        	<i style="padding-top: 2px; padding-right: 30px;" id="togglepassword" class="fas fa-eye password-icon"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
