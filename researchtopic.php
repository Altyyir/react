          ...
          <nav class="navbar navbar-expand">
            <div class="collapse navbar-collapse justify-content-between">
              <div class="header-left">
                <div class="dashboard_bar"> Research Title </div>
              </div>
          ...
          <div class="row page-titles">
            <ol class="breadcrumb">
              <li class="breadcrumb-item">
                <a href="kanban.php">Research Topic</a>
              </li>
              <li class="breadcrumb-item active">
                <a href="topics.php">Form</a>
              </li>
            </ol>
          </div>
          <div class="row">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div id="smartwizard" class="form-wizard order-create">
                    ...
                    <form method="get" action="insertresearchtopic.php">
                        ...
                        <div id="a" class="tab-pane" role="tabpanel">
                            <div class="row">
                              <div class="mb-12 col-md-12">
                                ...
                                <textarea class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Project Title"  name="research_project_title"></textarea>
                              </div>
                              ...
                              <div class="col-lg-6 mb-2" style="margin-top: 14px;">
                                ...
                                <select id="inputState" class="default-select form-control default-select wide" name="partnership" >
                              ...
                              <div class="mb-12 col-md-12" style="margin-top: 7px;">
                                <div class="mb-3">
                                  ...
                                  <input class="form-control form-control-lg" id="validationCustom04" rows="5" placeholder="Sponsor"  name="sponsor"></input>
                                </div>
                              </div>
                              <div class="row">
                              ...
                              <div class="col-lg-6 mb-3">
                                ...
                                <input class="form-control form-control-lg" type="text" placeholder="Batangas State University The National Engineering University" readonly>
                              </div>
                              <div class="col-lg-6 mb-3">
                                <label class="form-label">Revision No.</label>
                                <input class="form-control" type="number" name="revision" id="input2">
                              </div>
                              <div class="col-lg-6 mb-3">
                                <label class="form-label">Start Date <span class="text-danger">*</span>
                                </label>
                                <input type="date" value="" class="form-control form-control-lg" name="startdate">
                              </div>
                              <div class="col-lg-6 mb-3">
                                <label class="form-label">End Date <span class="text-danger">*</span>
                                </label>
                                <input type="date" value="" class="form-control form-control-lg" name="enddate">
                              </div>
                              <div class="col-lg-6 mb-3">
                                <label class="form-label">No. of BatStateU Female Participants <span class="text-danger">*</span>
                                </label>
                                <input class="form-control form-control-lg" value="0" type="number" name="female_no" id="input1" >
                                <div id="error-message" class="text-danger"></div>
                              </div>
                              <div class="col-lg-6 mb-3">
                                <label class="form-label">No. of BatStateU Male Participants <span class="text-danger">*</span>
                                </label>
                                <input class="form-control form-control-lg" value="0" type="number" name="male_no" id="input3" >
                        ...
                        <div id="b" class="tab-pane" role="tabpanel">
                          <div class="row">
                            <div class="col-lg-12 mb-3">
                              ...
                              <select class="form-control form-control-lg wide"  name="campus" id="campus" onchange="test()">
                                <option selected>Choose Campus</option>
                                <option>ARASOF-Nasugbu Campus</option>
                              </select>
                            </div>
                            <div class="col-lg-12 mb-3">
                              <label>College <span class="text-danger">*</span>
                              </label>
                              <select class="form-control form-control-lg wide"  name="college" id="college"></select>
                            </div>
                            <div class="col-lg-12 mb-3">
                                          ...
                                          <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body" style="padding: 0.875rem">
                                                <div class="card-body">
                                                  <div class="table-responsive">
                                                    <table class="table header-border table-responsive-sm" id="responsibilityTable">
                                                      <thead>
                                                        <tr>
                                                          <th class="col-md-4" style="text-align: left;">Role</th>
                                                          <th class="col-md-7" style="text-align: left;">Resposibility</th>
